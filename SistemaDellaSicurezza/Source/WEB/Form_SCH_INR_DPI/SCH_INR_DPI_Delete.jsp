    ...
    <version number="1.0" date="25/01/2004" author="Kushkarov Yura">
	      <comments>
				  <comment date="25/01/2004" author="Kushkarov Yura">
				   <description>Shablon formi SCH_INR_DPI_Delete.jsp</description>
				 </comment>	
				 <comments>
				 <comment date="27/01/2004" author="Treskina Maria">
				   <description>ydaleni iz tab</description>
				 </comment>	
      </comments> 
    </version>
  </versions>
...
{	
	//
	String COD_SCH_INR_DPI_DEL=request.getParameter("ID");
	ISchedeInterventoDPIHome home=(ISchedeInterventoDPIHome)PseudoContext.lookup("SchedeInterventoDPIBean");
	Long lCOD_SCH_INR_DPI=new Long(COD_SCH_INR_DPI_DEL);
	try{
		home.remove(lCOD_SCH_INR_DPI);
	}catch(Exception ex){
