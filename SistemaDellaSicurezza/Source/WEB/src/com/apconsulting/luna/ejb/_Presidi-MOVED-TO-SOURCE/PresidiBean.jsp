	...
	public PresidioView ejbGetPresidio(long lCOD_PSD_ACD){
		BMPConnection bmp=getConnection();
	      try{
			  ...
			  if(rs.next()){
					w.strNOM_CAG_PSD_ACD=rs.getString(1);
					w.strIDE_PSD_ACD=rs.getString(2);
	 ...
	 public Collection ejbGetPresidi_to_SCH_PSD_ACD_View(String SCH_PSD_ACD, long lCOD_AZL, String strSTA_INT, String strCAG_DOC, String strNOM_RSP_INR, long lCOD_CAG_PSD_ACD, String strNOM_CAG_PSD_ACD,  String strIDE_PSD_ACD, java.sql.Date dDAT_PIF_INR_DAL, java.sql.Date dDAT_PIF_INR_AL, java.sql.Date dDAT_INR_DAL, java.sql.Date dDAT_INR_AL, String strRAGGRUPPATI, String strSORT_PIF, String strSORT_INT, String strSORT_RSP)
{
    ...
    //--- STA_INT
      ...
      BMPConnection bmp=getConnection();
      try{
        PreparedStatement ps=bmp.prepareStatement("SELECT a.cod_sch_inr_psd,a.cod_psd_acd, a.dat_pif_inr, a.dat_inr, a.nom_rsp_inr, b.ide_psd_acd, c.nom_cag_psd_acd,e.rag_scl_azl FROM sch_inr_psd_tab a, ana_psd_acd_tab b, cag_psd_acd_tab c,ana_luo_fsc_tab d,ana_azl_tab e " + strFROM + " WHERE a.tpl_inr_psd = ?  AND a.cod_psd_acd = b.cod_psd_acd AND b.cod_cag_psd_acd = c.cod_cag_psd_acd AND b.cod_luo_fsc = d.cod_luo_fsc AND d.cod_azl = e.cod_azl AND d.cod_azl=? " + strWHERE + " " + strGROUP);
...
public Collection ejbGetPSD_Lov(long COD_AZL,long COD_CAG_PSD_ACD, long COD_PSD_ACD, String strNOM_CAG_PSD_ACD, String strIDE_PSD_ACD)
{
  ...
  if ( COD_PSD_ACD != 0){
        ...
        "SELECT a.cod_psd_acd,b.cod_cag_psd_acd, a.ide_psd_acd, a.dat_ult_ctl, a.esi_ult_ctl, b.nom_cag_psd_acd "
         +" FROM ana_psd_acd_tab a, cag_psd_acd_tab b, ana_luo_fsc_tab c "
         +" WHERE  a.cod_luo_fsc=c.cod_luo_fsc AND c.cod_azl = ? "
         +" AND a.cod_cag_psd_acd = b.cod_cag_psd_acd AND a.sta_psd_acd != 'S' "+vWhere+vOrder);
...
<%
/////////////////////////////////////////////////////////////
PseudoContext.bind(PresidiBean.BEAN_NAME, new PresidiBean());
/////////////////////////////////////////////////////////////
%>
