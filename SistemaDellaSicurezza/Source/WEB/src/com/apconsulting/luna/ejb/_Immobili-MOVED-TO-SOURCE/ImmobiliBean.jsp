...
//----------------------------------------------------------
  ...
  public void ejbRemove(){
      ...
      try{
         ...
         ps.setLong (1, COD_IMO);
         if(ps.executeUpdate()==0) throw new NoSuchEntityException("Immobili con ID= non è trovata");
      }
      catch(Exception ex)
	    {
          throw new EJBException(ex);
...
//<comment description="setter/getters">
    //1
      ...
      if( NOM_IMO.equals(newNOM_IMO) ) return;
      NOM_IMO = newNOM_IMO;
      setModified();
    }
	...
	// not required field
      ...
      if(DES_IMO!=null) {
			 if( DES_IMO.equals(newDES_IMO) ) return;
	    }
	    DES_IMO = newDES_IMO;
	    setModified();
    }
    public String getDES_IMO(){
		  if(DES_IMO==null)return "";
      return DES_IMO;
    }
   //</comment>
 	...
 	public Collection ejbFindEx(String strNOM_IMO, String strDES_IMO,	int iOrderParameter){
		...
		BMPConnection bmp=getConnection();
	     try{
			...
			if(strNOM_IMO != null)ps.setString(i++, strNOM_IMO.toUpperCase());
			if(strDES_IMO != null)ps.setString(i, strDES_IMO.toUpperCase());
			ResultSet rs=ps.executeQuery();
...
///////////ATTENTION!!////////////////////////////////////////
}//<comment description="end of implementation  ImmobiliBean"/>
%>
<%
////////////////////////////////////////// <BINDING> /////////////////////////////////////////////////////////////////
//<comment description="Obiazatelnaja sviazka classa s PsevdoContextom"/>
PseudoContext.bind("ImmobiliBean", new ImmobiliBean());
////////////////////////////////////////// </BINDING> /////////////////////////////////////////////////////////////////
%>
