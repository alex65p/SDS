...
public class QTA_View implements java.io.Serializable
{
	public long COD_QTA;
	public String DES_QTA;
}
public class CCP_View implements java.io.Serializable
{
	public long COD_CCP;
	public String DES_CCP;
}
public class TIP_View implements java.io.Serializable
{
	public long COD_TIP;
	public String DES_TIP;
}
public class CTR_View implements java.io.Serializable
{
	public long COD_CTR;
	public String DES_CTR;
}
public class TMP_ESP_View implements java.io.Serializable
{
	public long COD_TMP_ESP;
	public String DES_TMP_ESP;
}
public class DIS_View implements java.io.Serializable
{
	public long COD_DIS;
	public String DES_DIS;
}
public class ALG_View implements java.io.Serializable
{
	public long COD_ALG;
	public String DES_ALG;
}
