	      ...
	      <comments>
				  <comment date="25/01/2004" author="Podmasteriev Alexandr">
				   ...
				   <comment date="16/02/2004" author="Alex Kyba">
				  	 	<description>
							1. dobavlenna realizaziya metoda getAttivaManutenzioneByMacchina
							2. dobavlenna vyborka novyh poley v metode getAttivaManutenzione_UserID_View
						</description>
				 </comment>		
...
//public class AttivaManutenzioneBean extends BMPEntityBean implements IAttivaManutenzioneRemote
...
////////////////////// CONSTRUCTOR///////////////////
 private AttivaManutenzioneBean()
  {
	//System.err.println("AttivaManutenzioneBean constructor<br>");
  }
  ...
  public void ejbRemove(){
      ...
      try
	  {
         PreparedStatement ps=bmp.prepareStatement("DELETE FROM ana_ati_mnt_mac_tab  WHERE cod_mnt_mac=? AND cod_mac=?");
          ...
          if(ps.executeUpdate()==0) throw new NoSuchEntityException("AttivaManutenzione con ID="+COD_MNT_MAC+"  non è trovato");
      }
      catch(Exception ex)
	  {
          throw new EJBException(ex);
...
//<comment description="setter/getters">  
  ...
  public void setDES_ATI_MNT_MAC(String newDES_ATI_MNT_MAC){
      if(DES_ATI_MNT_MAC.equals(newDES_ATI_MNT_MAC)) return;
	...
	//-----3
      ...
      if((ATI_MNT_PER!=null)&&(ATI_MNT_PER.equals(newATI_MNT_PER))) return;
	...
	{
		if(PER_ATI_MNT_MES == newPER_ATI_MNT_MES) return;
	...
	{
		if(DAT_PAR_MNT_MAC!=null) if( DAT_PAR_MNT_MAC.equals(newDAT_PAR_MNT_MAC)) return;
...
///**********************************************************
       ...
       try{
         ...
         ResultSet rs=ps.executeQuery();
          ...
          while(rs.next()){
			...
			obj.strPER_ATI_MNT_MES=rs.getString(4);
			obj.strATI_MNT_PER=rs.getString(5);
			if (obj.strATI_MNT_PER.equals("S")) obj.strNB_ATI_MNT_PER="SI";
			if (obj.strATI_MNT_PER.equals("N")) obj.strNB_ATI_MNT_PER="NO";
			obj.dtDAT_PAR_MNT_MAC = rs.getDate(6);
			obj.strDES_MAC = rs.getString(7);
            al.add(obj);
          }
  ...
  //----FOR TAB VIEW ---------------
	 public Collection ejbGetAttivaManutenzione_TAB_View(long newCOD_MAC, long newCOD_MNT_MAC){
       BMPConnection bmp=getConnection();
       try{
         PreparedStatement ps=bmp.prepareStatement("SELECT  cod_sch_ati_mnt, ati_svo, esi_ati_mnt, dat_ati_mnt, dat_pif_inr, dat_pif_inr FROM sch_ati_mnt_tab WHERE cod_mac=? AND cod_mnt_mac=? order by ati_svo ");
...
PseudoContext.bind("AttivaManutenzioneBean", new AttivaManutenzioneBean());
////////////////////////////////////////// </BINDING> /////////////////////////////////////////////////////////////////
%>
