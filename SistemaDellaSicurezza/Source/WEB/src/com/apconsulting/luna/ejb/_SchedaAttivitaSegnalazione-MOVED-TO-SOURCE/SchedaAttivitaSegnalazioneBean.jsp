    ...
    <version number="1.0" date="05/02/2004" author="Podmasteriev Alexandr">
      <comments>
			   <comment date="05/02/2004" author="Podmasteriev Alexandr">
				   <description>Realizazija EJB dlia objecta SchedaAttivitaSegnalazione</description>
			   </comment>
			   <comment date="09/03/2004" author="Treskina Mary">
				   <description>Add view for SCH_MAC_Form</description>
			   </comment>
		</comments>
    </version>
  </versions>
...
public class SchedaAttivitaSegnalazioneBean extends BMPEntityBean implements ISchedaAttivitaSegnalazione, ISchedaAttivitaSegnalazioneHome
{
 ...
 //< ISchedaAttivitaSegnalazioneHome-implementation>
      ...
      public SchedaAttivitaSegnalazioneBean(){}
 ...
 //-----------------
  ...
  public void ejbRemove(){
      ...
      try{
         ...
         ps.setLong(1, lCOD_SCH_ATI_MNT);
         if(ps.executeUpdate()==0) throw new NoSuchEntityException("SchedaAttivitaSegnalazione with ID="+lCOD_SCH_ATI_MNT+" not found");
      }
      catch(Exception ex){
          throw new EJBException(ex);
      }
  ...
  //< setter-getters>
	...
	public void setCOD_MNT_MAC(long lCOD_MNT_MAC){
		if(this.lCOD_MNT_MAC==lCOD_MNT_MAC) return;
		this.lCOD_MNT_MAC=lCOD_MNT_MAC;
		setModified();
	}
	...
	public void setCOD_MAC(long lCOD_MAC){
		if(this.lCOD_MAC==lCOD_MAC) return;
		this.lCOD_MAC=lCOD_MAC;
		setModified();
	}
	...
	public void setATI_SVO(String strATI_SVO){
		if(  (this.strATI_SVO!=null) && (this.strATI_SVO.equals(strATI_SVO))  ) return;
	...
	public void setDAT_ATI_MNT(java.sql.Date dtDAT_ATI_MNT){
		if(this.dtDAT_ATI_MNT==dtDAT_ATI_MNT) return;
	...
	public void setESI_ATI_MNT(String strESI_ATI_MNT){
		if(  (this.strESI_ATI_MNT!=null) && (this.strESI_ATI_MNT.equals(strESI_ATI_MNT))  ) return;
	...
	public void setPBM_ATI_MNT(String strPBM_ATI_MNT){
		if(  (this.strPBM_ATI_MNT!=null) && (this.strPBM_ATI_MNT.equals(strPBM_ATI_MNT))  ) return;
	...
	public void setDAT_PIF_INR(java.sql.Date dtDAT_PIF_INR){
		if(this.dtDAT_PIF_INR==dtDAT_PIF_INR) return;
		this.dtDAT_PIF_INR=dtDAT_PIF_INR;
		setModified();
	}
	...
	public void setTPL_ATI(String strTPL_ATI){
		if(  (this.strTPL_ATI!=null) && (this.strTPL_ATI.equals(strTPL_ATI))  ) return;
		this.strTPL_ATI=strTPL_ATI;
		setModified();
	}
	 ...
	 public Collection ejbGetMacchina_for_SCHMAC_View(long lCOD_AZL, String strSCH_MAC, String strSTA_INT, java.sql.Date dDAT_PIF_INR_DAL, java.sql.Date dDAT_PIF_INR_AL, java.sql.Date dDAT_ATI_MNT_DAL, java.sql.Date dDAT_ATI_MNT_AL, String RG_GROUP, long NB_COD_MAC, long NB_COD_DPD, String NB_ATI_SVO, String strTYPE){
		...
		int iCOUNT_COD_AZL=0, iCOUNT_DAT_PIF_INR_DAL=0, iCOUNT_DAT_PIF_INR_AL=0, iCOUNT_DAT_ATI_MNT_DAL=0, iCOUNT_DAT_ATI_MNT_AL=0;
      	int indexATI_SVO=0, indexCOD_DPD=0, indexCOD_MAC=0;
			...
			if (strSTA_INT.equals("G")) strWHERE=strWHERE+" AND a.dat_ati_mnt IS NOT NULL ";
      ...
      try{
		...
		if (iCOUNT_COD_AZL!=0) ps.setLong(iCOUNT_COD_AZL, lCOD_AZL);
		...
		if (iCOUNT_DAT_ATI_MNT_DAL!=0) ps.setDate(iCOUNT_DAT_ATI_MNT_DAL, dDAT_ATI_MNT_DAL);
		if (iCOUNT_DAT_ATI_MNT_AL!=0) ps.setDate(iCOUNT_DAT_ATI_MNT_AL, dDAT_ATI_MNT_AL);
		if (indexCOD_DPD!=0) ps.setLong(indexCOD_DPD, NB_COD_DPD);
		if (indexATI_SVO!=0) ps.setString(indexATI_SVO, NB_ATI_SVO);
		if (indexCOD_MAC!=0) ps.setLong(indexCOD_MAC, NB_COD_MAC);
        ResultSet rs=ps.executeQuery();
        java.util.ArrayList al=new java.util.ArrayList();
        while(rs.next()){
...
<%
///////////////////////////////////////////////////////////////////////////////////////////////////
PseudoContext.bind(SchedaAttivitaSegnalazioneBean.BEAN_NAME, new SchedaAttivitaSegnalazioneBean());
///////////////////////////////////////////////////////////////////////////////////////////////////
%>
