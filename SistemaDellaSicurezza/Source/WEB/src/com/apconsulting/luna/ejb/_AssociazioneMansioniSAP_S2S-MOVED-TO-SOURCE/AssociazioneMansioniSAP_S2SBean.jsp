...
<description>AssociazioneMansioniSAP_S2SBean.jsp</description>
</comment>
</comments>
</version>
</versions>
...
%>
<%
// Mappo il bean nel contesto
PseudoContext.bind("AssociazioneMansioniSAP_S2SBean", new AssociazioneMansioniSAP_S2SBean());
%>
