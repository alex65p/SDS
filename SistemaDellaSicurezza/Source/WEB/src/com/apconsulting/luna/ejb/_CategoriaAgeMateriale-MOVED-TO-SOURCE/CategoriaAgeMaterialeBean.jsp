    ...
    <version number="1.0" date="23/01/2004" author="Valentina Ruggieri">
	      <comments>
				  <comment date="23/01/2004" author="Valentina Ruggieri">
				   <description>CategoriaAgeMaterialeBean.jsp</description>
				 </comment>
				 <comment date="29/03/2004" author="Yuriy Kushkarov">
...
////////////////////// CONSTRUCTOR///////////////////
 private CategoriaAgeMaterialeBean()
  {
	//System.err.println("CategoriaAgeMaterialeBean constructor<br>");
  }
  ...
  public void ejbRemove(){
      ...
      try
	  {
         PreparedStatement ps=bmp.prepareStatement("DELETE FROM cag_age_mat_tab  WHERE cod_cag_age_mat=?");
          ps.setLong (1, COD_CAG_AGE_MAT);
          if(ps.executeUpdate()==0) throw new NoSuchEntityException("CategoriaAgeMateriale con ID= non è trovata");
      }
      catch(Exception ex)
	  {
          throw new EJBException(ex);
...
PseudoContext.bind("CategoriaAgeMaterialeBean", new CategoriaAgeMaterialeBean());
