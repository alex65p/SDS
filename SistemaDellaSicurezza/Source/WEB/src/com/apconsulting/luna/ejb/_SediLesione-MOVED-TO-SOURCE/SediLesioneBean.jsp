    ...
    <version number="1.0" date="24/01/2004" author="Khomenko Juliya">
	      <comments>
				 ...
				 <comment date="29/03/2004" author="Yuriy Kushkarov">
				   <description>View findEx for ANA_SED_LES_View.jsp</description>
				 </comment>
      </comments>
    </version>
  </versions>
  ...
  public void ejbRemove(){
      ...
      try
	  {
         PreparedStatement ps=bmp.prepareStatement("DELETE FROM ana_sed_les_tab  WHERE cod_sed_les=?");
          ps.setLong (1, COD_SED_LES);
          if(ps.executeUpdate()==0) throw new NoSuchEntityException("SediLesione con ID= non è trovata");
      }
      catch(Exception ex)
	  {
          throw new EJBException(ex);
...
//<comment description="setter/getters">
	//1
      ...
      if( NOM_SED_LES.equals(newNOM_SED_LES) ) return;
	...
	//2
      ...
      if( TPL_SED_LES.equals(newTPL_SED_LES) ) return;
...
<%
////////////////////////////////////////// <BINDING> ////////
PseudoContext.bind("SediLesioneBean", new SediLesioneBean());
////////////////////////////////////////// </BINDING> ///////
%>
