  ...
  public void ejbRemove(){
      ...
      try
	  {
         PreparedStatement ps=bmp.prepareStatement("DELETE FROM ana_pno_tab  WHERE cod_pno=?");
          ps.setLong (1, COD_PNO);
          if(ps.executeUpdate()==0) throw new NoSuchEntityException("Piano con ID= non è trovata");
      }
      catch(Exception ex)
	  {
          throw new EJBException(ex);
...
//<comment description="setter/getters">
	//1
      ...
      if( NOM_PNO.equals(newNOM_PNO) ) return;
      NOM_PNO = newNOM_PNO;
      setModified();
    }
	...
	//3
      ...
      if(DES_PNO!=null){
	  	if( DES_PNO.equals(newDES_PNO) ) return;
	  }
	  DES_PNO = newDES_PNO;
	  setModified();
    }
    public String getDES_PNO(){
      if(DES_PNO==null){return "";}
			return DES_PNO;
    }
...
//===================================
///////////ATTENTION!!////////////////////////////////////////
}//<comment description="end of implementation  PianoBean"/>
%>
<%
////////////////////////////// <BINDING> ////////
PseudoContext.bind("PianoBean", new PianoBean());
////////////////////////////// </BINDING> ///////
%>
