  ...
  public void ejbLoad(){
      ...
      try{
         PreparedStatement ps=bmp.prepareStatement("SELECT cod_fat_rso,nom_fat_rso,des_fat_rso,num_fat_rso,cod_cag_fat_rso,cod_nor_sen FROM ana_fat_rso_tab WHERE cod_fat_rso=?");
           ...
           ResultSet rs=ps.executeQuery();
           if(rs.next()){
           		lCOD_FAT_RSO=ps.getLong(1);
	         		strNOM_FAT_RSO=ps.getString(2);
           		strDES_FAT_RSO=ps.getString(3);
           		lNUM_FAT_RSO=ps.getLong(4);
           		lCOD_CAG_FAT_RSO=ps.getLong(5);
           		lCOD_NOR_SEN=ps.getLong(6);
           }
           else{
...
<%
//////////////////////////////////////////  /////////////////////////////////////////////////////////////////
PseudoContext.bind(FattoriRischioBean.BEAN_NAME, new FattoriRischioBean());
//////////////////////////////////////////  /////////////////////////////////////////////////////////////////
%>
