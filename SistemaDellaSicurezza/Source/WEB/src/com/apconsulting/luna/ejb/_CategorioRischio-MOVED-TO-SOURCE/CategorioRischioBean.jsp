    ...
    <version number="1.0" date="24/01/2004" author="Malyuk Sergey">
	      <comments>
				  <comment date="24/01/2004" author="Malyuk Sergey">
				   ...
				   <description>added getCategorio_FattoriRischio_View(long COD_CAG_FAT_RSO)</description>
				 </comment>
		         <comment date="27/03/2004" author="Malyuk Sergey">
                   <description>Dobavlen FindEx
                 </comment>
      </comments>
    </version>
  </versions>
...
////////////////////// CONSTRUCTOR///////////////////
 private CategorioRischioBean()
  {
	//System.err.println("CategorioRischioBean constructor<br>");
  }
  ...
  public void ejbRemove(){
      ...
      try
	  {
         PreparedStatement ps=bmp.prepareStatement("DELETE FROM cag_fat_rso_tab  WHERE cod_cag_fat_rso=?");
          ps.setLong (1, COD_CAG_FAT_RSO);
          if(ps.executeUpdate()==0) throw new NoSuchEntityException("CategorioRischio con ID= non è trovata");
      }
      catch(Exception ex)
	  {
          throw new EJBException(ex);
...
//<comment description="setter/getters">
	//1
      ...
      if( NOM_CAG_FAT_RSO.equals(newNOM_CAG_FAT_RSO) ) return;
	...
	//3
      ...
      if(DES_CAG_FAT_RSO!=null){
	      if( DES_CAG_FAT_RSO.equals(newDES_CAG_FAT_RSO) ) return;
      }
...
PseudoContext.bind("CategorioRischioBean", new CategorioRischioBean());
////////////////////////////////////////// </BINDING> /////////////////////////////////////////////////////////////////
%>
