...
////////////////////// CONSTRUCTOR///////////////////
        private DipendenteCorsiBean() {
            //System.err.println("DipendenteCorsiBean constructor<br>");
        }
        ...
        public Collection getDipendenteCorsi_View(long lCOD_DPD) {
            return (new DipendenteCorsiBean()).ejbGetDipendenteCorsi_View(lCOD_DPD);
        }
...
//<comment description="setter/getters">
        ...
        public Collection ejbGetDipendenteCorsi_View(long lCOD_DPD) {

            BMPConnection bmp = getConnection();
            try {

                String sql = "SELECT a.cod_cor, a.nom_cor , a.des_cor," +
                        "b.dat_eft_cor " +
                        "FROM   ana_cor_tab a, cor_dpd_tab b " +
                        "WHERE  a.cod_cor = b.cod_cor AND b.cod_dpd=? ";
...
//<comment description="Obiazatelnaja sviazka classa s PsevdoContextom"/>
        PseudoContext.bind("DipendenteCorsiBean", new DipendenteCorsiBean());
////////////////////////////////////////// </BINDING> /////////////////////////////////////////////////////////////////
%>
