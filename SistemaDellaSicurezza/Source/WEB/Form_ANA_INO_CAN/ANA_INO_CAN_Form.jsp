...
%>
<%@page import="com.apconsulting.luna.ejb.DittaEsterna.IDittaEsternaHome"%>
...
<%@ page import="com.apconsulting.luna.ejb.AnagrCantieri.*" %>
...
<%@ include file="ANA_INO_CAN_Util.jsp" %>
...
<html>
    <head>
        ...
        <script type="text/javascript">
            document.write("<title>" + getCompleteMenuPath(SubMenuInfortuniCantiere,2) + "</title>");
        </script>
    ...
    <body>
        <%
                    ...
                    IDittaEsternaHome dithome = (IDittaEsternaHome) PseudoContext.lookup("DittaEsternaBean");
                    IDittaEsterna ditbean = null;

                    IAnagrCantieriHome can_home = (IAnagrCantieriHome) PseudoContext.lookup("AnagrCantieriBean");
                    IAnagrCantieri can_bean=null;
                    IErogazioneCorsiHome home1 = (IErogazioneCorsiHome) PseudoContext.lookup("ErogazioneCorsiBean");

                    ISediLesioneCantiereHome shome = (ISediLesioneCantiereHome) PseudoContext.lookup("SediLesioneCantiereBean");
                    ...
                    ICauseInfortuniHome thome = (ICauseInfortuniHome) PseudoContext.lookup("CauseInfortuniBean");
                    ...
                    if (request.getParameter("ID") != null) {
                        ...
                        ditbean = dithome.findByPrimaryKey(bean.getCOD_DTE());
                        can_bean = can_home.findByPrimaryKey(bean.getCOD_CAN());
                        ...
                        lPRG_INI = Formatter.format(bean.getPRG_INI());
                        strIN_ITI = Formatter.format(bean.getIN_ITI());
                        strNON_IND = Formatter.format(bean.getNON_IND());
                        strINT_TRA_DIT = Formatter.format(bean.getINT_TRA_DIT());
        ...
        %>
        <script type="text/javascript">
            function prepareDTE_DPD_Combo(changedElement){
                if (document.getElementById("COD_DTE") == null){
                    getDTE_DPD_Combo(
                        document.getElementById("DTE_DPD_Combo"),
                        <%=lCOD_DTE%>,
                        <%=lCOD_DPD%>,
                        <%=lCOD_AZL%>,
                        changedElement
                    ...
                    getDTE_DPD_Combo(
                        document.getElementById("DTE_DPD_Combo"),
                        document.getElementById("COD_DTE").value,
                        document.getElementById("COD_DPD").value,
                        <%=lCOD_AZL%>,
                        changedElement
                    );
                }
            ...
            function gestTIPO(){
                var tipo = document.getElementById("ID_COD_TPL_FRM_INO");
                if (document.getElementById("ID_IN_ITI").checked){
        ...
        <form action="ANA_INO_CAN_Set.jsp" method="post" target="ifrmWork" name="form_infortuni" id="form_infortuni_id">
            <input type="hidden" name="SBM_MODE" value="<%=(lCOD_INO == 0) ? "new" : "edt"%>">
            <input type="hidden" name="COD_INO" value="<%=lCOD_INO%>">
            <%if(lCOD_INO!=0){%>
            <input type="hidden" name="COD_DPD" id="COD_DPD" value="<%=lCOD_DPD%>"><%}%>
                ...
                <tr>
                    <td class="title">
                        <script type="text/javascript">
                            ...
                            (SubMenuInfortuniCantiere,2,<%=request.getParameter("ID")%>));
                        </script>
                    </td>
                </tr>
                <tr>
                                ...
                                <tr>
                                    <td>
                                        <fieldset>
                                            ...
                                            <table width="100%" border="0">
                                                <tr>
                                                    <td width="9%" align="right"><b><%=ApplicationConfigurator.LanguageManager.getString("Appaltatore")%>&nbsp;</b></td>
                                                    <td colspan="100%">
                                                    <div id="DTE_DPD_Combo">
                                                        <script type="text/javascript">
                                                            prepareDTE_DPD_Combo();
                                                        </script>
                                                    </div>
                                                </td>
                                                    <!--td>
                                                ...
                                                <!--tr>
                                                    ...
                                                    <td align="left">
                                                        ...
                                                        <select tabindex="1"  onchange="checkRiaperturaInfortuni('checkRiaperturaInfortuniCantiere.jsp?COD_DPD='+this.value+'&DAT_EVE_INO='+document.getElementById('DAT_EVE_INO').value+'&COD_INO='+document.getElementById('COD_INO').value+'&COD_INO_REL='+document.getElementById('ID_COD_REL_INO').value,document.getElementById('IDMessage'));" name="COD_DPD" style="width:100%;">
                                                            <option value="0"></option>=
                                                        </select>
                                ...
                                <tr>
                                    <td colspan="10">
                                        ...
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="right" nowrap><%=ApplicationConfigurator.LanguageManager.getString("Sede.lesione")%>&nbsp;</td>
                                                <td width="450px" align="left">
                                                    <select tabindex="3" name="COD_SED_LES" style="width:100%;">
                                                        <option></option>
                                                        <%=BuildSediLesioneCantiereComboBox(shome, lCOD_SED_LES)%>
                                                    </select>
                                                </td>
                                                <td align="right"><%=ApplicationConfigurator.LanguageManager.getString("Data.comunicazione")%>&nbsp;</td>
                                                <td align="left">
                                                    <s2s:Date tabindex="4" onchange="data_valida_cantiere();" id="DAT_COM_INO" name="DAT_COM_INO" value="<%=dtDAT_COM_INO%>"/></td>
                                                <td align="right" width="10%"><%=ApplicationConfigurator.LanguageManager.getString("Ora.della.comunicazione")%>&nbsp;</td>
                                                <td align="left"><input tabindex="5" type="text" size="5" maxlength="5"  name="ORA_LAV_INO" value="<%=strORA_LAV_INO%>"></td>
                                                <!--td align="right"><%=ApplicationConfigurator.LanguageManager.getString("Data.evento")%>&nbsp;</td>
                                                <td align="left">
                                                <s2s:Date tabindex="6" id="DAT_EVE_INO" name="DAT_EVE_INO" value="<%=dtDAT_EVE_INO%>"
                                                          onchange="setGiornoLavorativo();checkRiaperturaInfortuni('checkRiaperturaInfortuniCantiere.jsp?COD_DPD='+document.getElementById('COD_DPD').value+'&DAT_EVE_INO='+document.getElementById('DAT_EVE_INO').value+'&COD_INO='+document.getElementById('COD_INO').value+'&COD_INO_REL='+document.getElementById('ID_COD_REL_INO').value,document.getElementById('IDMessage'));
                                                          "/>
                                            </td-->
                                            ...
                                            <td align="left">
                                                ...
                                                <td align="left" ><input tabindex="7" type="hidden" id="DAT_INZ_ASZ_LAV" onchange="giorni_differenza(document.getElementById('DAT_INZ_ASZ_LAV').value,document.getElementById('DAT_FIE_ASZ_LAV').value);data_valida_cantiere();" name="DAT_INZ_ASZ_LAV" value="<%=dtDAT_INZ_ASZ_LAV%>"/></td>
                                                <td></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <select id="ID_COD_TPL_FRM_INO" tabindex="8" name="COD_TPL_FRM_INO" style="width:100%;">
                                                        <option></option>
                                                        <%=BuildCauseInfortunioComboBox(thome, lCOD_TPL_FRM_INO)%>
                                                    </select>
                                                </td>
                                                <td align="right"><%=ApplicationConfigurator.LanguageManager.getString("Data.infortunio")%>&nbsp;</td>
                                                <td align="left">
                                                    <s2s:Date tabindex="9" id="DAT_EVE_INO" name="DAT_EVE_INO" value="<%=dtDAT_EVE_INO%>"
                                                              onchange="data_valida_cantiere();giorni_differenza_CAN(document.getElementById('DAT_EVE_INO').value,document.getElementById('DAT_FIE_ASZ_LAV').value);setGiornoLavorativo();checkRiaperturaInfortuni('checkRiaperturaInfortuniCantiere.jsp?COD_DPD='+document.getElementById('COD_DPD').value+'&DAT_EVE_INO='+document.getElementById('DAT_EVE_INO').value+'&COD_INO='+document.getElementById('COD_INO').value+'&COD_INO_REL='+document.getElementById('ID_COD_REL_INO').value,document.getElementById('IDMessage'));
                                                              "/>
                                                </td>
                                                <td align="right"><%=ApplicationConfigurator.LanguageManager.getString("Ora.dell'evento.(hh.mm)")%>&nbsp;</td>
                                                <td align="left" width="9%">
                                                    <input tabindex="10" type="text" maxlength="2" name="ORA_EVE_INO_HOUR" value="<%=strORA_EVE_INO_HOUR%>" style="width:25px;">
                                                    &nbsp;:&nbsp;
                                                    <input tabindex="11" type="text" maxlength="2"  name="ORA_EVE_INO_MIN" value="<%=strORA_EVE_INO_MIN%>" style="width:25px;"></td>

                                                <td align="right"><%=ApplicationConfigurator.LanguageManager.getString("Giorno.lavorativo")%>&nbsp;</td>
                                                <td align="left" width="10%">
                                                    <select style="width: 100%; display: none;" tabindex="12" name="GOR_LAV_INO" id="GOR_LAV_INO_ID">
                                                    ...
                                                    <input style="width: 100%;" tabindex="13" id="GOR_LAV_INO_TXT_ID" value="" readonly>
                                                ...
                                                <td align="left"><input tabindex="14" type="text" size="15" maxlength="15" name="ORA_LAV_TUN_INO" value="<%=strORA_LAV_TUN_INO%>"></td>
                                            </tr>
                                            <tr>
                                                <td align="right" nowrap><b><%=ApplicationConfigurator.LanguageManager.getString("Luogo.fisico")%>&nbsp;</b></td>
                                                <td><select style="width: 100%;" name="COD_CAN" rows="1" tabindex="15">
                                                        <option value=''></option>
                                                        							    
                                                             <%=BuildCantiere1ComboBox(can_home, lCOD_CAN, lCOD_AZL)%>
                                                        
                                                    </select>
                                                </td>
                                                
                                                <td align="right"><%=ApplicationConfigurator.LanguageManager.getString("Data.fine.infortunio")%>&nbsp;</td>
                                                <td align="left" ><s2s:Date tabindex="16" id="DAT_FIE_ASZ_LAV" onchange="data_valida_cantiere();giorni_differenza_CAN(document.getElementById('DAT_EVE_INO').value,document.getElementById('DAT_FIE_ASZ_LAV').value);" name="DAT_FIE_ASZ_LAV" value="<%=dtDAT_FIE_ASZ_LAV%>"/></td>
                                                <td align="right" width="7%"><%=ApplicationConfigurator.LanguageManager.getString("Prognosi.iniziale")%>&nbsp;</td>
                                                <td align="left" ><input style="width:100%;" id="PRG_INI" tabindex="17"  type="text" size="20" maxlength="20" name="PRG_INI" value="<%=lPRG_INI%>"></td>
                                                <td align="right"><%=ApplicationConfigurator.LanguageManager.getString("Prognosi.finale")%>&nbsp;</td>
                                                <td align="left" ><input style="width:100%;" id="GOR_ASZ" tabindex="18"  type="text" size="20" maxlength="20" name="GOR_ASZ" value="<%=lGOR_ASZ%>"></td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <input type="checkbox" value="S" onclick="gestTIPO();" class="checkbox" id="ID_IN_ITI" name="IN_ITI" <%=(strIN_ITI.equals("S")) ? "checked" : ""%> tabindex="19">
                                                            </td>
                                                            <td align="right">
                                                                <%=ApplicationConfigurator.LanguageManager.getString("Interferenze.tra.ditte")%>&nbsp;
                                                            </td>
                                                            <td align="left">
                                                                <input type="checkbox" value="S" class="checkbox" name="INT_TRA_DIT" <%=(strINT_TRA_DIT.equals("S")) ? "checked" : ""%> tabindex="20">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="4">
                                                ...
                                                <td colspan="100%" align="left"><TEXTAREA tabindex="21" cols="100" rows="2" name="DES_EVE_INO" style="width:100%;"><%=strDES_EVE_INO%></TEXTAREA></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="left"><s2s:Date tabindex="22" id="DAT_TRA" name="DAT_TRA" value="<%=dtDAT_TRA%>"/></td>
                                            </tr>
                                            <tr>
                                                <td align="right" nowrap>
                                                                    ...
                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                        <tr>
                                                                            ...
                                                                            <td width="5%"><input <%=((strDIN_INC_INO != null && strDIN_INC_INO.equals("C")) ? "checked='true'" : "")%>
                                                                                    tabindex="23" type="radio" id="CON_DIN_INC" class="checkbox"
                                                                            ...
                                                                            <td width="5%"><input <%=((strDIN_INC_INO != null && strDIN_INC_INO.equals("S")) ? "checked='true'" : "")%>
                                                                                    tabindex="24" type="radio" id="SZA_DIN_INC" class="checkbox"
        ...
        <script type="text/javascript">
            ...
            tabbar.refreshTabUrl = "ANA_INO_CAN_Tabs.jsp";
        ...
        <%if (lCOD_INO != 0) {%>
        <script type="text/javascript">
            checkRiaperturaInfortuni('checkRiaperturaInfortuniCantiere.jsp?COD_DPD='+document.getElementById('COD_DPD').value+'&DAT_EVE_INO='+document.getElementById('DAT_EVE_INO').value+'&COD_INO='+document.getElementById('COD_INO').value+'&COD_INO_REL='+document.getElementById('ID_COD_REL_INO').value,document.getElementById('IDMessage'));
        </script>
        <%}%>
