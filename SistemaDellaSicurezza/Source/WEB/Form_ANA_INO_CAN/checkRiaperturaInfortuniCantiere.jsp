...
<table border="0" class="VIEW_TABLE" cellpadding="1" cellspacing="1">
    <tbody>
        <%
            ...
            Long COD_DPD = StringManager.isNotEmpty(request.getParameter("COD_DPD"))
                    ?new Long(request.getParameter("COD_DPD")):0;
            ...
            while (it.hasNext()) {
                SchedaInfortuniIncidenteCantiereView view = (SchedaInfortuniIncidenteCantiereView) it.next();
        %>
