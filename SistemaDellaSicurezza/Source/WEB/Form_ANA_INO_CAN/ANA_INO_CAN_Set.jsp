...
long lGOR_ASZ=c.checkLong(ApplicationConfigurator.LanguageManager.getString("Prognosi.iniziale"),request.getParameter("GOR_ASZ"),false);
long lPRG_INI=c.checkLong(ApplicationConfigurator.LanguageManager.getString("Prognosi.finale"),request.getParameter("PRG_INI"),false);
...
String strINT_TRA_DIT = c.checkString(ApplicationConfigurator.LanguageManager.getString("Interferenze.tra.ditte"), request.getParameter("INT_TRA_DIT"), false);
...
long lCOD_DTE=c.checkLong(ApplicationConfigurator.LanguageManager.getString("Appaltatore"),request.getParameter("COD_DTE"),true);
long lCOD_DPD=c.checkLong(ApplicationConfigurator.LanguageManager.getString("Lavoratore"),request.getParameter("COD_DPD"),true);
long lCOD_TPL_FRM_INO=c.checkLong(ApplicationConfigurator.LanguageManager.getString("Tipo.infortunio"),request.getParameter("COD_TPL_FRM_INO"), !strIN_ITI.equals("S"));
long lCOD_NAT_LES=c.checkLong("Natura lesione",request.getParameter("COD_NAT_LES"), false);
long lCOD_SED_LES=c.checkLong(ApplicationConfigurator.LanguageManager.getString("Sede.lesione"),request.getParameter("COD_SED_LES"),false);
long lCOD_CAN=c.checkLong(ApplicationConfigurator.LanguageManager.getString("Luogo.fisico"),request.getParameter("COD_CAN"),true);
...
strIN_ITI = strIN_ITI.equals("S")?"S":"N";
strNON_IND = strNON_IND.equals("S")?"S":"N";
strINT_TRA_DIT = strINT_TRA_DIT.equals("S")?"S":"N";
...
if(request.getParameter("SBM_MODE")!=null)
{
	...
	if(ReqMODE.equals("edt"))
	{
		...
		try{
			bean=home.create(lCOD_AGE_MAT, lCOD_TPL_FRM_INO, lCOD_NAT_LES, lCOD_SED_LES,lCOD_CAN, lCOD_LUO_FSC, lCOD_DPD, lCOD_DTE, lCOD_AZL);
	...
	if(bean!=null){
		...
		bean.setPRG_INI(lPRG_INI);
		bean.setIN_ITI(strIN_ITI);
		bean.setNON_IND(strNON_IND);
                bean.setINT_TRA_DIT(strINT_TRA_DIT);
