    ...
    try {
       ...
       // if (sCOD_SOP != null) {
            ...
            if ("DPD_INT".equals(strSubject)) {
                if (bean_dpd.addCOD_SOP_DPD(lCOD_DPD, "") == 0){
                    out.print("<script>alert('Selezionare un dipendente non appartenente alle ditte esterne')</script>");
                    return;
                }
            }
            else if ("DPD_EST".equals(strSubject)) {
                if (bean_dpd.addCOD_SOP_DPD_est(lCOD_DPD, "") == 0){
                    out.print("<script>alert('Selezionare un dipendente appartenente ad una delle ditte esterne')</script>");
                    return;
                }
