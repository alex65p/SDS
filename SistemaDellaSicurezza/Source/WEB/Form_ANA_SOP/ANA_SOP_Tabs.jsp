...
<%-- 
    Document   : ANA_SOP_Tabs
    Created on : 23-mar-2011, 10.33.29
    Author     : Alessandro
--%>
<%
...
<div id="dContent">
	...
	try {
		...
		out.print(BuildPersonaleRMTab(home, sCOD_SOP));
	    }
	    if (!isError && nameTab.equals("tab2")) {
		IDipendenteHome home = (IDipendenteHome) PseudoContext.lookup("DipendenteBean");
		out.print(BuildPersonaleImpreseTab(home, sCOD_SOP));
	    }
	    if (!isError && nameTab.equals("tab3")) {
		ISopraluogoHome home = (ISopraluogoHome) PseudoContext.lookup("SopraluogoBean");
		out.print(BuildRapportoTab(home, sCOD_SOP));
	    }
	    if (!isError && nameTab.equals("tab4")) {
		ISopraluogoHome home = (ISopraluogoHome) PseudoContext.lookup("SopraluogoBean");
		out.print(BuildCollegamentiTab(home, sCOD_SOP));
	    }
	    if (!isError && nameTab.equals("tab5")) {
		ISopraluogoHome home = (ISopraluogoHome) PseudoContext.lookup("SopraluogoBean");
		out.print(BuildFotoTab(home, sCOD_SOP));
	    }
	    if (!isError && nameTab.equals("tab6")) {
		ISopraluogoHome home = (ISopraluogoHome) PseudoContext.lookup("SopraluogoBean");
		out.print(BuildDocumentiTab(home, sCOD_SOP));
	    }
	    //----------------------------------------
	} catch (Exception ex) {
