...
<%
    /*
     ...
     <description>Shablon formi ANA_MAN_Delete.jsp</description>
     </comment>		
     </comments> 
     </version>
     </versions>
...
<script>
    ...
    <%
        ...
        if (LOCAL_MODE != null) {
            ID_PARENT = c.checkLong("ID_PARENT", request.getParameter("ID_PARENT"), true);
        }
        ID = c.checkLong("Doc Vlu", request.getParameter("ID"), true);
        ...
        try {
            if (LOCAL_MODE != null) {
                ...
                if (LOCAL_MODE.equals("DOC_VLU")) {
                    bean.removeCOD_ARE(ID);
                } else if (LOCAL_MODE.equals("DOC")) {
                    bean.removeCOD_DOC(ID);
                } else if (LOCAL_MODE.equals("ARC")) {
                    bean.removeCOD_ARC(ID);
                }
            } else {
