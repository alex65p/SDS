...
<%@ page import="s2s.luna.reports.Report_REP_ANA_UNI_SIC" %>
...
long lCOD_UNI_SIC=c.checkLong(ApplicationConfigurator.LanguageManager.getString("Unità"), request.getParameter("ID"), true);
...
out.clearBuffer();
Report_REP_ANA_UNI_SIC report = new Report_REP_ANA_UNI_SIC();

	report.lCOD_UNI_SIC=lCOD_UNI_SIC;
