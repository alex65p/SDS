...
<%@ page import="s2s.luna.reports.Report_REP_MAC_ATT" %>
...
long lCOD_MAC=c.checkLong(ApplicationConfigurator.LanguageManager.getString(
...
out.clearBuffer();
Report_REP_MAC_ATT report = new Report_REP_MAC_ATT(lCOD_MAC);
