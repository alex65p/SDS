...
<%-- 
    Document   : SUB_APP_ANA_RIS_Delete
    Created on : 29-mag-2008, 09.15.15
...
<%
    ISubAppAnalisiRischi SubAppAnalisiRischi = null;
    ...
    if ( strCOD_RSO != null) {
        ...
        try {
            ...
            home.remove(new SubAppAnalisiRischiPK(lCOD_SUB_APP, lCOD_RSO));
        } catch (Exception ex) {
