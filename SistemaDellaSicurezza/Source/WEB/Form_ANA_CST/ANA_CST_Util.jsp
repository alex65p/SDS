...
<%@ include file="../src/com/apconsulting/luna/conf/ApplicationConfigurator.jsp" %><%!
    String BuildRischiTab(IAnagrConstatazioniHome home, long lCOD_CST) {
        String str = "";
        long lCOD_AZL = Security.getAzienda();
        java.util.Collection col = home.getRischi_View(lCOD_CST, lCOD_AZL);
        ...
        str += "<tr style='display:none' ID='' INDEX='" + Formatter.format(lCOD_CST) + "'>";
        ...
        while (it.hasNext()) {
            ...
            str += "<tr INDEX='" + Formatter.format(lCOD_CST) + "' ID='" + obj.COD_RSO + "'>";
