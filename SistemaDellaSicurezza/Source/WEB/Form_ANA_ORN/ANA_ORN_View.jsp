...
<div id="divContent">
    <%
        ...
        String strNOM_ORN = c.checkStringEx("Nome", request.getParameter("NOM_ORN"), false);
    ...
    <table class="VIEW_TABLE" border="0">
        ...
        <tbody>
            <%
                Collection col = home.findEx(strNOM_ORN, 2);//getOrgani_View();
                Iterator it = col.iterator();
                int iCount = 0;
                while (it.hasNext()) {
                    Organi_View view = (Organi_View) it.next();
            %>
            <tr
                class="VIEW_TR" valign="top"
                INDEX="<%=view.COD_ORN%>" onclick="g_Handler.OnRowClick(this)" ondblclick="g_Handler.OnRowDblClick(this)"
                >
                <%  
...
<script>
    ...
    function OnViewLoad() {
        parent.g_Handler.setCaptionHTML(getCompleteMenuPath(SubMenuNormative, 2));

        parent.g_Handler.New.URL = "/luna/WEB/Form_ANA_ORN/ANA_ORN_Form.jsp";
        parent.g_Handler.New.Width = 45;    //  55;
        parent.g_Handler.New.Height = 15;   //  25;

        parent.g_Handler.Open = parent.g_Handler.New;

        parent.g_Handler.Delete.URL = "/luna/WEB/Form_ANA_ORN/ANA_ORN_Delete.jsp"; //?ID=32233223
        parent.g_Handler.Delete.OnBefore = OnBeforeDelete;
        parent.g_Handler.Help.URL = "/luna/WEB/Form_ANA_ORN/ANA_ORN_Help.jsp";
