    ...
    <table class="VIEW_TABLE" border=0>
        ...
        <tbody>
            ...
            <tr class="VIEW_TR" valign="top" INDEX="<%=lCOD_RSO%>" onclick="g_Handler.OnRowClick(this)" ondblclick="g_Handler.OnRowDblClick(this)">
                ...
                <td wrap>&nbsp;<%=Formatter.format(strNOM_RSO)%>&nbsp;</td>
                <td wrap>&nbsp;<%=Formatter.format(strNOM_FAT_RSO)%>&nbsp;</td>
            </tr>
            <%}%>
        </tbody>
...
<script>
    ...
    function OnViewLoad() {
        parent.g_Handler.setCaptionHTML(getCompleteMenuPath(SubMenuRischi, 2));
        parent.g_Handler.New.URL ="/luna/WEB/Form_ANA_RSO/ANA_RSO_Form.jsp";    
        parent.g_Handler.New.Width = "900px";//54;
        parent.g_Handler.New.Height = "400px";//34;
        //  parent.g_Handler.New.Height="630px";//34;

        parent.g_Handler.Open = parent.g_Handler.New;
        parent.g_Handler.Delete.URL = "/luna/WEB/Form_ANA_RSO/ANA_RSO_Delete.jsp";
        ...
        parent.g_Handler.Help.URL = "/luna/WEB/Form_ANA_RSO/ANA_RSO_Help.jsp";
         ...
         parent.g_Handler.dataTableArrayWidth=  [
                        ...
                        {"sWidth": "55%", "aTargets": [1], "sType": "string"} ,
                        {"sWidth": "38%", "aTargets": [2], "sType": "string"} 
                          ]   ;
    }
