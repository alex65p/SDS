                                ...
                                <td>
                                    <fieldset>
                                        ...
                                        <table border="0" width="100%">
                                            ...
                                            <tr>                                                
                                                <td align="right"><b><%=ApplicationConfigurator.LanguageManager.getString("Data.rilevazione")%></b>&nbsp;</td>
                                                <td><s2s:Date tabindex="3" id="DAT_RIL" name="DAT_RIL" value='<%=bean == null ? "" : Formatter.format(dtDAT_RIL)%>'/></td>                                              
                                                <%
                                                ...
                                                <td align="right"><b><%=ApplicationConfigurator.LanguageManager.getString("Rifacimento.valutazione.(in.mesi)")%></b>&nbsp;</td>
                                                <td>
                                                    <input tabindex="5" type="text"  size="15"  maxlength="2"  name="RFC_VLU_RSO_MES" value="<%=bean == null ? "" : Formatter.format(lRFC_VLU_RSO_MES)%>">
                                                </td>
                                            </tr>
                                            <tr>
