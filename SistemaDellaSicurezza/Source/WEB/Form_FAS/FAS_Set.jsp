...
<%-- 
    Document   : FAS_Set
    Created on : 15-apr-2011, 15.42.53
    Author     : Alessandro
--%>
...
<%
            ...
            if (request.getParameter("SBM_MODE") != null) {
                ...
                long lCOD_FAS = c.checkLong("COD_FAS", request.getParameter("COD_FAS"), false);
...
//=======================================================================================
                if (ReqMODE.equals("edt")) {
                    ...
                    Long fas_id = new Long(lCOD_FAS);
                    bean = home.findByPrimaryKey(fas_id);
                    bean.setlCOD_FAS(lCOD_FAS);            //1
...
<script>
    if(!err){
        ...
        parent.ToolBar.OnNew("ID=<%=bean.getlCOD_FAS()%>");
    }else{
