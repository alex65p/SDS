...
<%-- 
    Document   : SUB_APP_PRO_SOS_Set
    Created on : 23-mag-2008, 10.36.55
...
<%
    ...
    if (request.getParameter("SBM_MODE") != null) {
        ...
        String strPRO_SOS_SUB_APP_DES = c.checkString(ApplicationConfigurator.LanguageManager.getString("Descrizione.bassa"), request.getParameter("PRO_SOS_SUB_APP_DES"), false);
        ...
        if (ReqMODE.equals("edt")) {
            ...
            bean = home.findByPrimaryKey(new SubAppProdottiSostanzePK(lCOD_SUB_APP, lCOD_PRO_SOS));
            try {
            } catch (Exception ex) {
            ...
            try {
                bean = home.create(lCOD_SUB_APP, strDES);
            } catch (Exception ex) {
                out.print("<script>Alert.Error.showDublicate();err=true;</script>");
                return;
            }
        ...
        if (bean != null) {
                ...
                con_ser_bean.setPRO_SOS_SUB_APP_DES(strPRO_SOS_SUB_APP_DES);
        }
    }
%>
<script type="text/javascript">
