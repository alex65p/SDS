...
<%-- 
    Document   : SCH_SIC_Form
    Created on : 6-apr-2011, 15.35.35
    Author     : Alessandro
--%>
...
<html>
    <head>
        <title>
            <%=ApplicationConfigurator.LanguageManager.getString("Schede.di.sicurezza")%> 
            - 
    ...
    <body>
        <%
            ...
            if (request.getParameter("ID_PARENT") != null) {
                if (request.getParameter("ID") != null) {
                    String strCOD_SCH_SIC = request.getParameter("ID");
                    Long sch_sic_id = new Long(strCOD_SCH_SIC);
                    bean = home.findByPrimaryKey(sch_sic_id);
                    lCOD_SCH_SIC = sch_sic_id.longValue();
        ...
        <!-- form for addind  -->
        <form action="SCH_SIC_Set.jsp"  method="POST" target="ifrmWork" style="margin:0 0 0 0;">
            <input name="SBM_MODE" type="Hidden" value="<%if ((lCOD_SCH_SIC == 0)) {
                    out.print("new");
                } else {
                    out.print("edt");
                }%>">
            <input type="hidden" name="COD_PSC" value="<%=lCOD_PSC%>">
            <input type="hidden" name="COD_SCH_SIC" value="<%=lCOD_SCH_SIC%>">
            <input type="hidden" name="COD_AZL" value="<%=lCOD_AZL%>">
            <input name="ID_PARENT" type="Hidden" value="<%=strID_PARENT%>">
            <input name="COD_PRO" id="COD_PRO" type="Hidden" value="<%=lCOD_PRO%>">
            <input id="frmCode" type="hidden" value="S">
                                    ...
                                    <fieldset>
                                        ...
                                        <table  width="100%" border="0">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="5"><input tabindex="3" size="20" readonly type="text" maxlength="50" name="COD" value="<%=strCOD%>"></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div id="REV_ajaxReturnDiv">
                                                        <input readonly tabindex="6" size="25" type="text" maxlength="1" id="REV" name="REV" value="<%=strREV%>">
                                                    </div>
                                                </td>
                                                <td align="right"><%=ApplicationConfigurator.LanguageManager.getString("Data.emissione")%>&nbsp;</td>
                                                <td><s2s:Date tabindex="7" id="DAT_EMI" onchange="confronta_date();dis(this.value);checkDateRevisionePrecedente(this.value);getRev();" name="DAT_EMI" value="<%=dtDAT_EMI%>"/></td>
