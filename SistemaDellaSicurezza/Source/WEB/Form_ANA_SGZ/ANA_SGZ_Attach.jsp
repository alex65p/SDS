...
<%
    ...
    <file>
    <versions>	
    <version number="1.0" date="17/02/2004" author="Yuriy Kusharov">		
    <comments>
    <comment date="17/02/2004" author="Yuriy Kusharov">
    </comment>		
    </comments> 
    </version>
    </versions>
...
<%
    ...
    String strSubject = request.getParameter("ATTACH_SUBJECT");
    ...
    try {
        if ("R".equals(strSubject)) {
            bean.addRischio(Long.valueOf(ID));
        } else {
            return;
        }
    } catch (Exception ex) {
