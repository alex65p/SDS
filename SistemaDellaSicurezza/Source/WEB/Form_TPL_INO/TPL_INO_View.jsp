...
<div id="divContent">
    <%
        ...
        String strNOM_TPL_INO = c.checkStringEx("Titolo", request.getParameter("NOM_TPL_INO"), false);
        if (c.isError) {
            String err = c.printErrors();
            out.println("<script>alert(\"" + err + "\");</script>");
            return;
        }
        ITipologieAccertamentiHome aHome = (ITipologieAccertamentiHome) PseudoContext.lookup("TipologieAccertamentiBean");

        Collection col = aHome.findEx(strNOM_TPL_INO, 1);
    ...
    <table class="VIEW_TABLE" border="0">
        ...
        <tbody>
            <%
                int i = 1;
                while (it.hasNext()) {
                    TipologieAccertamenti_UserID_View view = (TipologieAccertamenti_UserID_View) it.next();
            %>
            <tr 
                class="VIEW_TR" valign="top"
                INDEX="<%=view.COD_TPL_INO%>" onclick="g_Handler.OnRowClick(this)" ondblclick="g_Handler.OnRowDblClick(this)"
                >

                <td>&nbsp;<%=i++%>&nbsp;</td>

                <td>&nbsp;<%=Formatter.format(view.NOM_TPL_INO)%>&nbsp;</td>
            </tr>
            <%
                }
            %>
...
<script>
    ...
    function OnViewLoad() {
        parent.g_Handler.setCaptionHTML(getCompleteMenuPath(SubMenuInfortuni, 5));

        parent.g_Handler.New.URL = "/luna/WEB/Form_TPL_INO/TPL_INO_Form.jsp";
        parent.g_Handler.New.Width = 38;
        parent.g_Handler.New.Height = 11;

        parent.g_Handler.Open = parent.g_Handler.New;

        parent.g_Handler.Delete.URL = "/luna/WEB/Form_TPL_INO/TPL_INO_Delete.jsp";
        parent.g_Handler.Delete.OnBefore = OnBeforeDelete;
        parent.g_Handler.Help.URL = "/luna/WEB/Form_TPL_INO/TPL_INO_Help.jsp";
