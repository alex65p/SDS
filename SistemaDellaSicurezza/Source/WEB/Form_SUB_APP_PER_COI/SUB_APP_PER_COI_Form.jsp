...
<%-- 
    Document   : SUB_APP_PER_COI_Form
    Created on : 22-mag-2008, 9.27.56
...
<%
            ...
            if (strCOD_PER_COI != null) {
                bean = home.findByPrimaryKey(new SubAppPersonaleCoinvoltoPK(Long.parseLong(strCOD_SUB_APP), Long.parseLong(strCOD_PER_COI)));
...
<form action="SUB_APP_PER_COI_Set.jsp"  method="POST" target="ifrmWork" style="margin:0 0 0 0;">
