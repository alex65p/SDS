...
<div id="divContent">
    <%
        ...
        String strNOM_SOT_SET = c.checkStringEx("Nome", request.getParameter("NOME"), true);
        ...
        ISottosettori Sottosettori;

        Collection col = home.findEx(strNOM_SOT_SET, 2);//getSottosettori_View();
    ...
    <table class="VIEW_TABLE" border="0">
        ...
        <tbody>
            <%
                int iCount = 0;
                while (it.hasNext()) {
                    Sottosettori_View view = (Sottosettori_View) it.next();
            %>		<tr class="VIEW_TR" valign="top" INDEX="<%=view.COD_SOT_SET%>" onclick="g_Handler.OnRowClick(this)" ondblclick="g_Handler.OnRowDblClick(this)">
               
                <%  
                        out.println("<td>&nbsp;" + ++iCount + "&nbsp;</td><td>&nbsp;"
                                + Formatter.format(view.NOM_SOT_SET) + "&nbsp;</td><td>&nbsp;"
                                + Formatter.format(view.DES_SOT_SET) + "&nbsp;</td></tr>");
...
<script>
    ...
    function OnViewLoad() {
        parent.g_Handler.setCaptionHTML(getCompleteMenuPath(SubMenuNormative, 1));

        parent.g_Handler.New.URL = "/luna/WEB/Form_ANA_SOT_SET/ANA_SOT_SET_Form.jsp";
        parent.g_Handler.New.Width = 45;//55;
        parent.g_Handler.New.Height = "250px";//15
        //  parent.g_Handler.New.Height=15;//25;

        parent.g_Handler.Open = parent.g_Handler.New;

        parent.g_Handler.Delete.URL = "/luna/WEB/Form_ANA_SOT_SET/ANA_SOT_SET_Delete.jsp"; //?ID=32233223
        parent.g_Handler.Delete.OnBefore = OnBeforeDelete;
        parent.g_Handler.Help.URL = "/luna/WEB/Form_ANA_SOT_SET/ANA_SOT_SET_Help.jsp";
