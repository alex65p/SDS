    ...
    <version number="1.0" date="27/02/2004" author="Yuriy Kushkarov">		
      <comments>
		  <comment date="27/02/2004" author="Yuriy Kushkarov">
		   <description>SCH_DBT_FRM_View.jsp</description>
		 </comment>
      </comments> 
    </version>
  </versions>
...
%>
	...
	<tr class="VIEW_HEADER_TR">
		<td>Descrizione</td><td>Modello</td><td>Targa</td><td>Identificativo</td>
	</tr>
<%%>
...
<script>
	parent.g_Handler.New.URL="/luna/WEB/Form_SCH_DBT_FRM/SCH_DBT_FRM_Form.jsp";
	parent.g_Handler.New.Width="780px";
	parent.g_Handler.New.Height="380px";
