...
<div id="divContent">
    <%
        ...
        ICauseInfortuniHome aHome = (ICauseInfortuniHome) PseudoContext.lookup("CauseInfortuniBean");
    ...
    <table class="VIEW_TABLE" border="0">
        <thead>
            <tr class="VIEW_HEADER_TR">
                ...
                <th>&nbsp;<%=ApplicationConfigurator.LanguageManager.getString("Tipo.di.infortunio")%>&nbsp;</th>
            </tr>
        </thead>
        <tbody>
            <%
                int i = 1;
                while (it.hasNext()) {
                    findEx_cau_inf view = (findEx_cau_inf) it.next();
            %>
            <tr
        ...
        <tfoot <%=!ApplicationConfigurator.isModuleEnabled(MODULES.ENHANCED_GRID) ? "style='display: none;'" : ""%>>
            <tr>
                ...
                <th><input type="text" name="cerca_Tipo.di.infortunio" value="Cerca <%=ApplicationConfigurator.LanguageManager.getString("Tipo.di.infortunio")%>" class="search_init" /></th>
            </tr>
        </tfoot>
    </table>
</div>
<script>
    ...
    function OnViewLoad() {
        parent.g_Handler.setCaptionHTML(getCompleteMenuPath(SubMenuInfortuniCantiere, 1));

        parent.g_Handler.New.URL = "/luna/WEB/Form_CAU_INF_CAN/CAU_INF_CAN_Form.jsp";
        parent.g_Handler.New.Width = 40;
        parent.g_Handler.New.Height = 13;

        parent.g_Handler.Open = parent.g_Handler.New;

        parent.g_Handler.Delete.URL = "/luna/WEB/Form_CAU_INF_CAN/CAU_INF_CAN_Delete.jsp";
