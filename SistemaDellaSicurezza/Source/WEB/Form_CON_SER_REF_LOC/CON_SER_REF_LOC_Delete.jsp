...
<%-- 
    Document   : CON_SER_REF_LOC_Delete
    Created on : 27-mag-2008, 10.35.40
...
<%
            IContServReferentiLoco ContServReferentiLoco = null;
            ...
            if (strCOD_DPD != null) {
                ...
                try {
                    ...
                    long lCOD_DPD = Long.parseLong(strCOD_DPD);
                    home.remove(new ContServReferentiLocoPK(Security.getAzienda(), lCOD_SRV, lCOD_DPD));
                } catch (Exception ex) {
                    ex.printStackTrace();
