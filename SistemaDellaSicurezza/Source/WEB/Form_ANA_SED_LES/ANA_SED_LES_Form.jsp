...
<head>
<script>
    document.write("<title>" + getCompleteMenuPath(SubMenuInfortuni,0) + "</title>");
</script>
...
<form action="ANA_SED_LES_Set.jsp"  method="" target="ifrmWork" style="margin:0 0 0 0;">
  ...
  <tr><td class="title">
    <script>
        document.write(getCompleteMenuPathFunction
            (SubMenuInfortuni,0,<%=request.getParameter("ID")%>));
    </script>
  </td></tr>
  <tr>
	<td> 
...
<!-- ########################### -->
  ...
  <fieldset>
   ...
   <td align="right" ><b><%=ApplicationConfigurator.LanguageManager.getString("Nome.sede")%>&nbsp;</b></td>
	 ...
	 <tr><td valign="top" align="right"> <b><%=ApplicationConfigurator.LanguageManager.getString("Tipologia.sede")%>&nbsp;</b></td>
	 <td><input tabindex="2" size="85" type="text" maxlength="150" name="TPL" value="<%=strTPL_SED_LES%>">
	 </td>
	 </tr>
   </td></tr>
   </table>	 
