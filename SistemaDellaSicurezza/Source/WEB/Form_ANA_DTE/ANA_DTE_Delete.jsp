...
<file>
  <versions>
    <version number="1.0" date="27/12/2004" author="Roman Chumachenko">
	      <comments>
				  <comment date="27/12/2004" author="Roman Chumachenko">
				   <description>ANA_DTE_Delete.jsp</description>
				 </comment>		
      </comments>
    </version>
  </versions>
...
{	
	...
	Long dte_id=new Long(ID_TO_DEL);
	try{
		home.remove(dte_id);
	}catch(Exception ex){
