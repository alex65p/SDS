...
<html>
    ...
    <script language="JavaScript" src="../_scripts/SDS_CalendarCheck.js"></script>
    <style>
        .getList{
            width:20px;
            height:20px;
        ...
        <table cellpadding="10" border="0" cellspacing="" width="100%" >
            ...
            out.println(str);
                                        ...
                                        <tr>
                                            ...
                                            <td align="left"><input tabindex="4" type="text" size="3" maxlength="4"  name="VER_MIS_PET" value="<%=lVER_MIS_PET%>" onkeypress="validate(event)"> </td>
                ...
                out.print("selected");
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="5">
                                                <s2s:textarea tabindex="7" cols="100" style="width:99%" rows="4" name="DES_MIS_PET" maxlength="3500"><%=Formatter.format(strDES_MIS_PET)%></s2s:textarea>
                                            </td>
                                        </tr>
