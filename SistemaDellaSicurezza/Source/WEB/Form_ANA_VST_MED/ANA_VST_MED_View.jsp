    ...
    <table border="0" class="VIEW_TABLE">
        ...
        <tbody>
            <%
                ...
                String strNOM_VST_MED = c.checkStringEx("Nome Visita", request.getParameter("NOM_VST_MED"), false);
                String strDES_VST_MED = c.checkStringEx("Descrizione", request.getParameter("DES_VST_MED"), false);
                ...
                //  java.util.Collection col = home.getVisiteMediche_All_View(Security.getAzienda());
                java.util.Collection col = home.findEx(lCOD_AZL, strNOM_VST_MED, strDES_VST_MED, lPER_VST, 0);
                String Per = "";
                java.util.Iterator it = col.iterator();
                int nCount = 0;
                while (it.hasNext()) {
                    VisiteMediche_All_View obj = (VisiteMediche_All_View) it.next();
            %>		<tr
                class="VIEW_TR" valign="top"
                INDEX="<%=obj.COD_VST_MED%>" onclick="g_Handler.OnRowClick(this)" ondblclick="g_Handler.OnRowDblClick(this)"
                >
                <%
                        ...
                        out.println("<td>&nbsp;" + ++nCount + "&nbsp;</td><td>&nbsp;"
                                + Formatter.format(obj.NOM_VST_MED) + "&nbsp;</td><td>&nbsp;"
                                + Per + "&nbsp;</td><td>&nbsp;"
                                + Formatter.format(obj.DES_VST_MED) + "&nbsp;</td></tr>");
...
<script>
    ...
    function OnViewLoad() {
        parent.g_Handler.setCaptionHTML(getCompleteMenuPath(SubMenuVerificheSanitarie, 0));

        parent.g_Handler.New.URL = "/luna/WEB/Form_ANA_VST_MED/ANA_VST_MED_Form.jsp";
        parent.g_Handler.New.Width = 48;
        parent.g_Handler.New.Height = 18;

        parent.g_Handler.Open = parent.g_Handler.New;

        parent.g_Handler.Delete.URL = "/luna/WEB/Form_ANA_VST_MED/ANA_VST_MED_Delete.jsp";
        parent.g_Handler.Delete.OnBefore = OnBeforeDelete;
        parent.g_Handler.Help.URL = "/luna/WEB/Form_ANA_VST_MED/ANA_VST_MED_Help.jsp";
