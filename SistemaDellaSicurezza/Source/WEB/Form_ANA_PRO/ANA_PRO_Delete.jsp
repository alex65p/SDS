...
<%
    ...
    try {
        if (LOCAL_MODE != null) {
            IAnagrProcedimento bean = home.findByPrimaryKey(Long.parseLong(ID_PARENT));
            if (LOCAL_MODE.equals("CAN")) {
                bean.deleteCantiere(Long.parseLong(ID), Long.parseLong(ID_PARENT));
            }
        } else {
