...
/*String BuildOpereTab(IAnagrProcedimentoHome home, long lCOD_PRO)
{
	String str = "";
...
String BuildCantieriTab(IAnagrProcedimentoHome home, long lCOD_PRO)
{
	String str = "";
	long lCOD_AZL = Security.getAzienda();
	java.util.Collection col = home.getCantieri_View(lCOD_PRO, lCOD_AZL);
   ...
   str+="</tr>";
	...
	while(it.hasNext()){
    	...
    	str+="<tr INDEX='"+Formatter.format(lCOD_PRO)+"' ID='"+obj.COD_CAN+"'>";
