...
<%
ITipologieFormeDinfortunio TipologieFormeDinfortunio=null;
long lCOD=0;
  ...
  if(ReqMODE.equals("edt"))
	{
		...
		ITipologieFormeDinfortunioHome home=(ITipologieFormeDinfortunioHome)PseudoContext.lookup("TipologieFormeDinfortunioBean");
		Long utn_id=new Long(c.checkLong("TipologieFormeDinfortunio ID",request.getParameter("UTN_ID"),true));
		if (c.isError)
		{
			String err = c.printErrors();
		...
		TipologieFormeDinfortunio = home.findByPrimaryKey(utn_id);
		//getting of parameters and set the new object variables
		
		try{
			TipologieFormeDinfortunio.setNOM_TPL_FRM_INO(strNOM_TPL_FRM_INO);
			TipologieFormeDinfortunio.setTIP_TPL_FRM_INO(strTIP_TPL_FRM_INO);
		}catch(Exception ex){
...
//=======================================================================================
	...
	try{
		ITipologieFormeDinfortunioHome home=(ITipologieFormeDinfortunioHome)PseudoContext.lookup("TipologieFormeDinfortunioBean");
		TipologieFormeDinfortunio=home.create(strTIP_TPL_FRM_INO,strNOM_TPL_FRM_INO);
		lCOD=TipologieFormeDinfortunio.getCOD_TPL_FRM_INO();
	}catch(Exception ex){
			out.print("<script>Alert.Error.showDublicate();err=true;</script>");
		}	
		}
