...
<head>
<script>
    document.write("<title>" + getCompleteMenuPath(SubMenuInfortuni,4) + "</title>");
</script>
<LINK REL=STYLESHEET
...
if(request.getParameter("ID")!=null)
{
	...
	//getting of TipologieFormeDinfortunio object
		...
		strNOM_TPL_FRM_INO=TipologieFormeDinfortunio.getNOM_TPL_FRM_INO();
		strTIP_TPL_FRM_INO=TipologieFormeDinfortunio.getTIP_TPL_FRM_INO();
...
<form action="TPL_FRM_INO_Set.jsp"  method="POST" target="ifrmWork">
  ...
  <tr><td class="title">
    <script>
        document.write(getCompleteMenuPathFunction
            (SubMenuInfortuni,4,<%=request.getParameter("ID")%>));
    </script>      
  </td></tr>
  <tr>
	<td>
    ...
    <%ToolBar.bCanDelete=(TipologieFormeDinfortunio!=null);%>	
    <%=ToolBar.build(2)%> 
    <!-- ########################### -->
	</table>
   <fieldset>
