...
<head>
<script>
    document.write("<title>" + getCompleteMenuPath(SubMenuDVR,2) + "</title>");
</script>
  ...
  <tr><td class="title">
    <script>
        document.write(getCompleteMenuPathFunction
            (SubMenuDVR,2,<%=request.getParameter("ID")%>));
    </script>      
  </td></tr>
  <tr>
	<td>
...
<br>
   ...
   <tr>
                  <td align="right" width="15%"> 
                    <b><%=ApplicationConfigurator.LanguageManager.getString("Azienda/Ente")%>&nbsp;</b></td>
	 <td ><input style="width:100%;" maxlength="50" type="text" name="" value="<%=strRAG_SCL_AZL%>" readonly>
   </td></tr>
   </table>	 
	</td></tr>
  <tr><td>
	 ...
	 <legend><%=ApplicationConfigurator.LanguageManager.getString("Dati.paragrafo")%></legend>
              <table  width="100%" border="0" cellpadding="3">
                <tr>
                        ...
                        <td align="right" width="15%"><b><%=ApplicationConfigurator.LanguageManager.getString("Sezione")%>&nbsp;</b></td>
...
%>      
		 <select tabindex="1" <%=hid%> style="width:100%;">
	    	<option value=""></option>
   	    <%=BuildSezioneComboBox(GestioniSezioniHome, lCOD_ARE, lCOD_AZL)%>
		 </select></td></tr>
     <tr>
                        <td align="right" width="85%"><b><%=ApplicationConfigurator.LanguageManager.getString("Capitolo")%>&nbsp;</b></td>
	   <td>
<%
if(request.getParameter("ID_PARENT")!=null)
{
...
%>
	    <div id="sel" style="width:556px;">
		<select tabindex="2" id="CAPITOLO" name="COD_CPL" style="width:100%;">
   ...
   <tr>
	 ...
	 <td><input tabindex="3" maxlength="99" size="105" type="text" name="TITOLO" value="<%=strNOM_PRG%>">
   </td></tr>
	 <tr>
                  <td width="15%" align="right" valign="top"><%=ApplicationConfigurator.LanguageManager.getString("Descrizione")%>&nbsp;</td>
	 <td><textarea style="width:100%;" tabindex="4" rows="5" cols="107" name="DESC"><%=Formatter.format(strDES_PRG)%></textarea>
   </td></tr>
<% if (cod_id_parent != null){ %>
	 <tr>
                  <td width="15%" align="right" ><%=ApplicationConfigurator.LanguageManager.getString("Priorità")%>&nbsp;</td>
	     <td><input style="width:30%;" tabindex="5" name="PRIORITY" value="<%=Formatter.format(lPRIORITY)%>" /></td>
	 </tr>
         <script>
window.dialogWidth="700px";
...
<!-- /form for addind  Paragrafo-->
    <iframe name="ifrmWork" class="ifrmWork" src="ANA_PRG_UtilFind.jsp?ID=<%=lCOD_ARE%>&AZL=<%=lCOD_AZL%>&SEL=<%=lCOD_CPL%>&PAR=<%=(request.getParameter("ID_PARENT")!=null)%>"></iframe>
<script type="text/javascript">
<!--
// changeFields();
// -->
