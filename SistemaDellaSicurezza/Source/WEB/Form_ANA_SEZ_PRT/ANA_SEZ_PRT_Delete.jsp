...
<%-- 
    Document   : ANA_SEZ_PRT_Delete
    Created on : 18-apr-2011, 14.40.09
    Author     : Alessandro
--%>
...
Checker c = new Checker();
            long ID;
            ISezioneParticolareHome fasHome=(ISezioneParticolareHome)PseudoContext.lookup("SezioneParticolareBean");
