...
<%-- 
    Document   : ANA_SEZ_PRT_Form
    Created on : 22-mar-2011, 12.36.25
    Author     : Alessandro
--%>
...
<html>
    <head>
        <title>
            <%=ApplicationConfigurator.LanguageManager.getString("Sezione.particolare")%> 
            - 
        ...
        <script type="text/javascript" src="../Form_ANA_ATT/ANA_ATT.js"></script>
    ...
    <body>
        <%
            ...
            // Codice Sezione particolare
            String strID = request.getParameter("ID");
            String newID = request.getParameter("COD");
            String TIT = Formatter.format(request.getParameter("TIT"));
            // Codice Procedimento
            ...
            if (strID_PARENT != null) {
                if (strID != null) {
                    lCOD_SEZ_PAR = Long.parseLong(strID);
                    bean = home.findByPrimaryKey(lCOD_SEZ_PAR);
        ...
        <!-- form for addind  -->
        <form action="ANA_SEZ_PRT_Set.jsp"  method="POST" target="ifrmWork" style="margin:0 0 0 0;">
            <input name="SBM_MODE" type="Hidden" value="<%if ((lCOD_SEZ_PAR == 0)) {
                    out.print("new");
                } else {
                    out.print("edt");
                }%>">
            <input type="hidden" name="COD_PSC" value="<%=lCOD_PSC%>">
            <input type="hidden" name="COD_SEZ_PAR" value="<%=lCOD_SEZ_PAR%>">
            ...
            <input id="frmCode" type="hidden" value="P">
                                    ...
                                    <fieldset>
                                        ...
                                        <table  width="100%" border="0">
                                            <tr>
                                                ...
                                                <td colspan="3"><input readonly style="width: 100%;" tabindex="1" class="textBackground" maxlength="50"  value="<%=strTIT_PSC%>"></td>
                                                <td align="right"><%=ApplicationConfigurator.LanguageManager.getString("Codice.PSC")%>&nbsp;</td>
                                                <td><input readonly tabindex="2" class="textBackground" maxlength="50" style="width: 100%;" value="<%=strCOD_PSC%>"></td>
                                            </tr>
                                            <tr>
                                                <td align="right"><b><%=ApplicationConfigurator.LanguageManager.getString("Codice")%>&nbsp;</b></td>
                                                <%   if (StringManager.isEmpty(newID)) {
                                                        String COD = home.getUltimoCodice(lCOD_PRO);
                                                        if (StringManager.isEmpty(COD)) {
                                                            strCOD = "P01";
                                                        } else {
                                                            long lCOD = Long.parseLong(COD);
                                                            lCOD = lCOD + 1;
                                                            if (lCOD < 10) {
                                                                strCOD = "P0" + lCOD;
                                                            } else {
                                                        ...
                                                        strCOD = home.getUltimoCodice_Sez(lCOD_PRO, newID);
                                                        long lCOD = Long.parseLong(strCOD);
                                                        if (lCOD < 10) {
                                                            strCOD = "P0" + strCOD;
                                                        } else {
                                                            strCOD = "P" + strCOD;
                                                ...
                                                %>
                                                <td><input tabindex="3" type="text" readonly maxlength="50" name="COD" value="<%=strCOD%>"></td>
                                                <td align="right"><b><%=ApplicationConfigurator.LanguageManager.getString("Titolo")%></b>&nbsp;</td>
                                                <%if (newID == "") {%>
                                                <td colspan="3"><input tabindex="4" style="width: 100%;" type="text" maxlength="100" name="TIT" value="<%=strTIT%>"></td>
                                                    <% } else {%>
                                                <td colspan="3"><input tabindex="4" style="width: 100%;" type="text" maxlength="100" name="TIT" value="<%=TIT%>"></td>
                                                    <%}%>
                                            </tr>
                                            <tr>
                                                <td align="right"><%=ApplicationConfigurator.LanguageManager.getString("Oggetto")%>&nbsp;</td>
                                                <td colspan="5"><s2s:textarea tabindex="5" cols="74" rows="3" maxlength="1000" id="OGG" name="OGG"><%=strOGG%></s2s:textarea></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <td><input tabindex="2" type="hidden" maxlength="50" name="COD" value="PSC-<%=bean_vr.getstrCOD()%>"></td>
                                            </tr>
                                                <%
                                                    Alphabet c = new Alphabet();
                                                    String REV1 = home.getUltimaRevisione(lCOD_PRO, strCOD);
                                                    if (REV1 != "") {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div id="REV_ajaxReturnDiv">
                                                        <input readonly tabindex="6" type="text" maxlength="1" id="REV" name="REV" value="<%=strREV%>">
                                                    </div>
                                                </td>
                                                ...
                                                <td><s2s:Date tabindex="8" id="DAT_PRO" onchange="confronta_date();data_protocollo(document.getElementById('DAT_EMI').value);" name="DAT_PRO" value="<%=dtDAT_PRO%>"/></td>
                                            </tr>
                                            <%if (request.getParameter("ID") == null) {
                                                ...
                                                String DOC_PRE = home.getUltimo_Doc_Sez(lCOD_PRO, newID);
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <input id="DOC_COL" type="Hidden" value="<%=strDOC_COL%>" name="ATTACHMENT_FILE" type="text">
                                                            </td>
                                                            <td>
                                                                &nbsp;
                                                                <button id='btnAttivita' onclick='g_openAttivitaWindow();' title='Apri "Anagrafica attività"'>
                                                                    <img src='../_images/new/COPY.GIF'>
                                                                </button>
                                                            </td>
                                                        </tr>
                                                    </table>
