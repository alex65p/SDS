...
function goEGZ_COR()
{
  result=window.showModalDialog('../Form_SCH_EGZ_COR/SCH_EGZ_COR_Form.jsp?ID='+document.all["COD_SCH_EGZ_COR"].value,'','dialogHeight:530px;dialogwidth:820px;scroll:yes;status:no;help:no');
}
