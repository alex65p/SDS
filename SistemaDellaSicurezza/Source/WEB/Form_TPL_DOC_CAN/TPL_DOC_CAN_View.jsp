    ...
    <table class="VIEW_TABLE" border="0">
        ...
        <tbody>
            <%
                ...
                String strCOL_SOP = c.checkStringEx("Collegamento.con.sopralluogo", request.getParameter("COL_SOP"), false);
                String strALL_STA_SOP = c.checkStringEx("Tipologia.acquisizione.POS", request.getParameter("ALL_STA_SOP"), false);
                String strTPL_ACQ_POS = c.checkStringEx("Allegato.stampa.sopralluogo", request.getParameter("TPL_ACQ_POS"), false);
                ...
                ITipologiaDocumentiCantiereHome aHome = (ITipologiaDocumentiCantiereHome) PseudoContext.lookup("TipologiaDocumentiCantiereBean");
                java.util.Collection col = aHome.findEx(strNOM_TPL_DOC, strDES_TPL_DOC, strCOL_SOP, strALL_STA_SOP, strTPL_ACQ_POS, 2);
...
<script>
    ...
    function OnViewLoad() {
        parent.g_Handler.setCaptionHTML(getCompleteMenuPath(SubMenuDocumentiAreaSicurezza, 0));

        parent.g_Handler.New.URL = "/luna/WEB/Form_TPL_DOC_CAN/TPL_DOC_CAN_Form.jsp";
        ...
        parent.g_Handler.Delete.URL = "/luna/WEB/Form_TPL_DOC_CAN/TPL_DOC_CAN_Delete.jsp";
