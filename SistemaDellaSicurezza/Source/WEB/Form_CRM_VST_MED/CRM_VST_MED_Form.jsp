...
<file>
  <versions>
    <version number="1.0" date="15/03/2004" author="Yuriy Kushkarov">
          <comments>
                  <comment date="15/03/2004" author="Yuriy Kushkarov">
...
<body>
<form action="CRM_VST_MED_Set.jsp" id="frm1" method="post" target="ifrmWork">
...
function goSearch(){
    document.all["frm1"].action="CRM_VST_MED_Tabs.jsp";
    document.all["frm1"].submit();
}

function goSave(){
    document.all["frm1"].action="CRM_VST_MED_Set.jsp";
    document.all["frm1"].submit();
}
</script>
</body>
