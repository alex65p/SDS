...
try{
	...
	long lCOD_UNI_ORG=c.checkLong("Unita organizzativa",request.getParameter("COD_UNI_ORG"), true);
	...
	//-- array of ids ---
	home.deleteFattoriRischiByUnita(lCOD_AZL, lCOD_UNI_ORG);
	
	it = arlist.iterator();
	if (it!=null){	
		while (it.hasNext()){
			Long lCOD_FAT_RSO = (Long)it.next();
			home.addFattoreRischioPerUnita(lCOD_AZL, lCOD_UNI_ORG, lCOD_FAT_RSO.longValue());
