...
<html>
<head>
	<title><%=ApplicationConfigurator.LanguageManager.getString("Gestione.fattori.di.rischio.per.unità.organizzativa")%></title>
</head>
...
{
	lCOD_UNI_ORG=Long.parseLong( request.getParameter("ID_PARENT") );
	lCOD_AZL=Security.getAzienda();
}
%>
<table align="center" width="100%" cellpadding="0" cellspacing="0" border="0">
<!-- ##################################################################################### -->
<tr><td align="center" class="title"><%=ApplicationConfigurator.LanguageManager.getString("Gestione.fattori.di.rischio.per.unità.organizzativa")%></td></tr>    
<tr>
    <td td valign="top" style="border:2px solid #4B6A89">
...
<!-- ##################################################################################### -->
         <form action="GEST_FAT_RSO_UNI_ORG_Set.jsp" method="POST" target="ifrmWork" style="margin:0 0 0 0;">
	...
	<table id="DataTable" class='dataTable' cellpadding='1' cellspacing='0' border="0">
  	<%
  		java.util.Collection col = home.getFattoriUWithoutRischiView(lCOD_AZL, lCOD_UNI_ORG);;
		java.util.Iterator it = col.iterator();
  		while(it.hasNext()){
			...
			%>
		   	<tr>
				<td class='dataTd' align="center" ><input readonly type="Text" value="<%=Formatter.format(obj.NOM_FAT_RSO)%>" class='dataInput'></td>
	...
	<input type="Hidden" value="<%=Formatter.format(lCOD_UNI_ORG)%>" name="COD_UNI_ORG">

	</form>  
	</td>
 </tr>
</table>
<iframe name="ifrmWork" class="ifrmWork" src="../empty.txt" style="width:100%;height:300"></iframe>
<script>
// -- OnReturn --
function OnReturn(){
