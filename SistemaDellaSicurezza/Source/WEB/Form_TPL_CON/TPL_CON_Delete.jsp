...
<%
    /*
     ...
     <description>Shablon formi TPL_MIS_PET_Delete.jsp</description>
     </comment>		
     </comments> 
     </version>
     </versions>
...
<%    if (request.getParameter("ID") != null) {
        String COD_TPL_MIS_DEL = request.getParameter("ID");
        ITipologiaContrattiHome home = (ITipologiaContrattiHome) PseudoContext.lookup("TipologiaContrattiBean");
        Long lCOD_TPL_MIS = new Long(COD_TPL_MIS_DEL);
        try {
            home.remove(lCOD_TPL_MIS);
        } catch (Exception ex) {
