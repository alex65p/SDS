    ...
    <table class="VIEW_TABLE" border=0>
        ...
        <tbody>
            <%
                ...
                String strNOM_TPL_CON = c.checkStringEx(ApplicationConfigurator.LanguageManager.getString("Nome"), request.getParameter("NOM_TPL_CON"), true);
                String strDES_TPL_CON = c.checkStringEx(ApplicationConfigurator.LanguageManager.getString("Descrizione"), request.getParameter("DES_TPL_CON"), false);
                ...
                ITipologiaContrattiHome aHome = (ITipologiaContrattiHome) PseudoContext.lookup("TipologiaContrattiBean");

                java.util.Collection col = aHome.findEx(strNOM_TPL_CON, strDES_TPL_CON, 2);
                java.util.Iterator it = col.iterator();
                int iCount = 0;
                while (it.hasNext()) {

                    TipologiaContratti_View obj = (TipologiaContratti_View) it.next();

            %>
            <tr	class="VIEW_TR" valign="top"	INDEX="<%=obj.lCOD_TPL_CON%>"
                onclick="g_Handler.OnRowClick(this)" ondblclick="g_Handler.OnRowDblClick(this)">
                
                 <% 
                 out.println("<td>&nbsp;" + ++iCount + "&nbsp;</td>"
                            + "<td>&nbsp;" + Formatter.format(obj.strNOM_TPL_CON) + "&nbsp;</td>"
                            + "<td>&nbsp;" + Formatter.format(obj.strDES_TPL_CON) + "&nbsp;</td>");
...
<script type="text/javascript">
    ...
    function OnViewLoad() {
        parent.g_Handler.setCaptionHTML(getCompleteMenuPath(SubMenuAzienda, 3));

        parent.g_Handler.New.URL = "/luna/WEB/Form_TPL_CON/TPL_CON_Form.jsp";
        parent.g_Handler.New.Width = 60;
        parent.g_Handler.New.Height = 17;

        parent.g_Handler.Open = parent.g_Handler.New;

        parent.g_Handler.Delete.URL = "/luna/WEB/Form_TPL_CON/TPL_CON_Delete.jsp";
        parent.g_Handler.Delete.OnBefore = OnBeforeDelete;
        parent.g_Handler.Help.URL = "/luna/WEB/Form_TPL_CON/TPL_CON_Help.jsp";
