...
<%-- 
    Document   : SEZ_GEN_Form
    Created on : 6-apr-2011, 15.05.44
    Author     : Alessandro
--%>
...
<html>
    <head>
        <title>
            <%=ApplicationConfigurator.LanguageManager.getString("Sezione.generale")%> 
            - 
        ...
        <script type="text/javascript" src="SEZ_GEN.js"></script>
    ...
    <body>
        <%
            ISezioneGenerale sezionegenerale = null;
            ...
            if (request.getParameter("ID_PARENT") != null) {
                if (request.getParameter("ID") != null) {
                    String strCOD_SEZ_GEN = request.getParameter("ID");
                    Long sez_gen_id = new Long(strCOD_SEZ_GEN);
                    sezionegenerale = home.findByPrimaryKey(sez_gen_id);
                    lCOD_SEZ_GEN = sez_gen_id.longValue();

                    strCOD = Formatter.format(sezionegenerale.getstrCOD());
                    strOGG = Formatter.format(sezionegenerale.getstrOGG());
                    strREV = Formatter.format(sezionegenerale.getstrREV());
                    dtDAT_EMI = Formatter.format(sezionegenerale.getdtDAT_EMI());
                    dtDAT_PRO = Formatter.format(sezionegenerale.getdtDAT_PRO());
                    strDOC_COL = Formatter.format(sezionegenerale.getstrDOC_COL());
                    lCOD_AZL = sezionegenerale.getlCOD_AZL();
                } else {
                    lCOD_PRO = Long.parseLong(strCOD_PRO);
                }
            }
        ...
        <!-- form for addind  -->
        <form action="SEZ_GEN_Set.jsp"  method="POST" target="ifrmWork" style="margin:0 0 0 0;">
            <input name="SBM_MODE" type="Hidden" value="<%if ((lCOD_SEZ_GEN == 0)) {
                    out.print("new");
                } else {
                    out.print("edt");
                }%>">
            <input type="hidden" name="COD_PSC" value="<%=lCOD_PSC%>">
            <input type="hidden" id="COD_SEZ_GEN" name="COD_SEZ_GEN" value="<%=lCOD_SEZ_GEN%>">
            ...
            <input id="frmCode" type="hidden" value="G">
                                    ...
                                    <fieldset>
                                        ...
                                        <table  width="100%" border="0">
                                            <tr>
                                                ...
                                                <td><input readonly tabindex="2" size="20" class="textBackground" style="width: 100%;" maxlength="50"  value="<%=strCOD_PSC%>"></td>
                                            </tr>
                                            <tr>
                                                <td align="right"><b><%=ApplicationConfigurator.LanguageManager.getString("Codice")%>&nbsp;</b></td>
                                                <td colspan="5"><input readonly tabindex="3" size="20" type="text" maxlength="50" id="COD" name="COD" value="<%=strCOD%>"></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <td ><input tabindex="5" size="36" type="hidden" maxlength="50" name="COD" value="PSC-<%=bean_vr.getstrCOD()%>"></td>
                                            </tr>
                                            <%
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div id="REV_ajaxReturnDiv">
                                                        <input readonly tabindex="6" size="2bor5" type="text" maxlength="1" name="REV" id="REV" value="<%=strREV%>">
                                                    </div>
                                                </td>
