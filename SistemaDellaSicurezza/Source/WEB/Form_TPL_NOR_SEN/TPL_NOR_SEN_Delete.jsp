...
<%
    /*
     ...
     <description>Shablon formi ANA_TPL_NOR_SEN_Delete.jsp</description>
...
<%    if (request.getParameter("ID") != null) {
        String COD_TPL_NOR_SEN_DEL = request.getParameter("ID");
        ITipologieNomativeSentenzeHome home = (ITipologieNomativeSentenzeHome) PseudoContext.lookup("TipologieNomativeSentenzeBean");
        Long lCOD_TPL_NOR_SEN = new Long(COD_TPL_NOR_SEN_DEL);
        try {
            home.remove(lCOD_TPL_NOR_SEN);
        } catch (Exception ex) {
