...
<%@ include file="../src/com/apconsulting/luna/ejb/Nazionalita/NazionalitaBean_Interfaces.jsp" %>
<%@ include file="../src/com/apconsulting/luna/ejb/Nazionalita/NazionalitaBean.jsp" %>
