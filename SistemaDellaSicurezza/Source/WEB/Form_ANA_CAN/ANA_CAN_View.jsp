...
<div id="divContent">
    <%
        ...
        long lCOD_CAN = c.checkLong("Opera", request.getParameter("COD_CAN"), false);
        String strDES_CAN = c.checkStringEx("Descrizione", request.getParameter("DES_CAN"), false);
        String strNOM_CAN = c.checkStringEx("Codice", request.getParameter("NOM_CAN"), false);
    ...
    %><script>alert("<%=err%>");</script><%
        ...
        Collection col = home.findEx(strDES_CAN, strNOM_CAN, Security.getAzienda());
    %>
    <table class="VIEW_TABLE" border="0">
        ...
        <tbody>
            <%
                ...
                int i = 1;
                while (it.hasNext()) {
                    AnagrCantieri_All_View v = (AnagrCantieri_All_View) it.next();
                    lCOD_CAN = v.COD_CAN;
                    strDES_CAN = v.DES_CAN;
                    strNOM_CAN = v.NOM_CAN;
                    //  strNOM_FAT_RSO=v.strNOM_FAT_RSO;
            %>
            <tr class="VIEW_TR" valign="top" INDEX="<%=lCOD_CAN%>" onclick="g_Handler.OnRowClick(this)" ondblclick="g_Handler.OnRowDblClick(this)">
                <td>&nbsp;<%=i++%>&nbsp;</td>
                <td>&nbsp;<%=Formatter.format(strNOM_CAN)%>&nbsp;</td>
                <td>&nbsp;<%=Formatter.format(strDES_CAN)%>&nbsp;</td>
            </tr>
            <%}%>
        </tbody>
...
<script>
    ...
    function OnViewLoad() {
        parent.g_Handler.setCaptionHTML(getCompleteMenuPath(SubMenuAnagraficagenerale, 1));
        parent.g_Handler.New.URL = "/luna/WEB/Form_ANA_CAN/ANA_CAN_Form.jsp";
        parent.g_Handler.New.Width = "900px";//54;
        parent.g_Handler.New.Height = "400px";//34;
        //  parent.g_Handler.New.Height="630px";//34;

        parent.g_Handler.Open = parent.g_Handler.New;
        parent.g_Handler.Delete.URL = "/luna/WEB/Form_ANA_CAN/ANA_CAN_Delete.jsp";
