...
<%-- 
    Document   : APP_ANA_RIS_Form
    Created on : 28-mag-2008, 15.25.18
...
<%
    ...
    IAppAnalisiRischiHome home = (IAppAnalisiRischiHome) PseudoContext.lookup("AppAnalisiRischiBean"); 
    IAppAnalisiRischi bean = null;
    
    if (strCOD_RSO != null)
    {
        bean = home.findByPrimaryKey(new AppAnalisiRischiPK(Long.parseLong(strCOD_SRV), Long.parseLong(strCOD_RSO)));
...
<form action="APP_ANA_RIS_Set.jsp"  method="POST" target="ifrmWork" style="margin:0 0 0 0;">
