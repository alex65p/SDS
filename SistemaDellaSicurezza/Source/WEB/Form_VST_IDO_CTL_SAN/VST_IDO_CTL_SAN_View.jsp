...
java.util.Collection col = home.getCTL_VST_IDO_View();
java.util.Iterator it = col.iterator();
 int	nCount = 0;
while(it.hasNext()){
		CTL_VST_IDO_View obj=(CTL_VST_IDO_View)it.next();
%>		<tr
			class="VIEW_TR" valign="top"
			INDEX='<%=obj.COD_CTL_SAN%>' ID='<%=obj.COD_VST_IDO%>' onclick="g_Handler.OnRowClick(this)" ondblclick="g_Handler.OnRowDblClick(this)"
			>
<%
	out.println("<td>&nbsp;" + ++nCount + "&nbsp;</td><td>&nbsp;"+
							 Formatter.format(obj.NOM_VST_IDO)+"&nbsp;</td></td><td>&nbsp;"+
...
<script>
	...
	function OnViewLoad(){
			...
			parent.g_Handler.setCaptionHTML("<%=ApplicationConfigurator.LanguageManager.getString("Visite.di.idoneita")%>");

			parent.g_Handler.New.URL="/luna/WEB/Form_VST_IDO_CTL_SAN/VST_IDO_CTL_SAN_Form.jsp";
			parent.g_Handler.New.Width=55;
			parent.g_Handler.New.Height=29;

			parent.g_Handler.Open=parent.g_Handler.New;

			parent.g_Handler.Delete.URL="/luna/WEB/Form_VST_IDO_CTL_SAN/VST_IDO_CTL_SAN_Delete.jsp";
