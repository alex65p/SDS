...
<td>
<fieldset>
<legend><%=ApplicationConfigurator.LanguageManager.getString("Mansioni.presenti.nel.repository")%></legend>
<table border=0 cellpadding="0" cellspacing="0">
<tr>
    <td>
...
<td align="left" colspan="100%">
  <table>
	  <tr>
		  <td height="3" style="white-space:nowrap"><img src="../_images/PALLA-ROSSA.gif" alt="<%=ApplicationConfigurator.LanguageManager.getString("Rossa")%>">&nbsp;<%=ApplicationConfigurator.LanguageManager.getString("Record.già.caricati")%></td>
		</tr>
	</table>
</td>
</tr>
...
function goSearch(){
    document.all["frm1"].action="CRM_ANA_MAN_Tabs.jsp";
    document.all["frm1"].submit();
}
function goSave(){
    document.all["frm1"].action="CRM_ANA_MAN_Set.jsp";
    document.all["frm1"].submit();
}
</script>
</body>
