...
<table border="0"  class="VIEW_TABLE">
        ...
        <tr class="<%=RowStyle%>" valign="top" INDEX="<%=view.COD_DPD%>" onclick="g_Handler.OnRowClick(this)" ondblclick="g_Handler.OnRowDblClick(this)">
            ...
            <%
                    jspOutputBuilder = new StringBuilder(300);
                        jspOutputBuilder.append("<td ></td>");
                        jspOutputBuilder.append("<td nowrap>&nbsp;");
                        jspOutputBuilder.append(Formatter.format(view.COG_DPD)).append("&nbsp;</td><td wrap>&nbsp;");
                        jspOutputBuilder.append(Formatter.format(view.NOM_DPD)).append("&nbsp;</td><td wrap>&nbsp;");
                        jspOutputBuilder.append(Formatter.format(view.NOM_FUZ_AZL)).append("&nbsp;</td><td wrap>&nbsp;");
                        jspOutputBuilder.append(Formatter.format(view.DAT_NAS_DPD)).append("&nbsp;</td>");
    ...
    <tfoot <%=!ApplicationConfigurator.isModuleEnabled(MODULES.ENHANCED_GRID) ? "style='display: none;'" : ""%>>
        <tr>
<% 
String cercaCognome="Cerca"+ApplicationConfigurator.LanguageManager.getString("Cognome");
String cercaNome="Cerca"+ApplicationConfigurator.LanguageManager.getString("Nome");
String cercaFunzAziendale="Cerca"+ApplicationConfigurator.LanguageManager.getString("Funz.Aziendale");
String cercaDataNascita="Cerca"+ApplicationConfigurator.LanguageManager.getString("Data.di.nascita");
%>
<th></th>
            <th><input type="text" name="cerca_Cognome"         value="Cerca <%=cercaCognome%>" class="search_init" /></th>
            <th><input type="text" name="cerca_Nome"            value="Cerca <%=cercaNome%>" class="search_init" /></th>
            <th><input type="text" name="cerca_Funz.Aziendale"  value="Cerca <%=cercaFunzAziendale%>" class="search_init" /></th>
            <th><input type="text" name="cerca_Data.di.nascita" value="Cerca <%=cercaDataNascita%>" class="search_init" /></th>
        </tr>
    </tfoot>        
</table>
 <br/><br/><br/>
