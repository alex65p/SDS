    ...
    <version number="1.0" date="27/02/2004" author="Roman Chumachenko">
	   <comments>
		  <comment date="27/02/2004" author="Roman Chumachenko">
			<description>MIS_PET_MAN_AttachDel.jsp</description>
		  </comment>
       </comments> 
    </version>
  </versions>
...
<%
	...
	//
	out.println("id_attachment:"+id_attachment+"<br>");
	//-------------------------------------------------------------------------
	try{
			//
			IInterventoAudutHome ia_home=(IInterventoAudutHome)PseudoContext.lookup("InterventoAudutBean");
			ia_home.remove(id_attachment);
			out.print("<script>Alert.Success.showDeleted();</script>");
			out.println("DELETING INTERVENTA AUDIT OK");
	//-------------------------------------------------------------------
	}
	catch(Exception ex){
