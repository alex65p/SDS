    ...
    <version number="1.0" date="03/03/2004" author="Roman Chumachenko">
	   <comments>
		  <comment date="03/03/2004" author="Roman Chumachenko">
			<description>AZN_CRR_PET_AttachDel.jsp</description>
		  </comment>
       </comments> 
    </version>
  </versions>
...
<%
	...
	try{
		...
		id_attachment=(String)request.getParameter("ID");
	}
	catch(Exception ex){
...
//-------------------------------------------------------------------------
	...
	try{
		if ("DOCUMENT".equals(strSubject)){
			bean.removeDOC_GEST_AZN_CRR_PET(id_attachment);
			out.print("DELETING DOCUMENT OK");
		}
//-------------------------------------------------------------------------
	}
	catch(Exception ex){
