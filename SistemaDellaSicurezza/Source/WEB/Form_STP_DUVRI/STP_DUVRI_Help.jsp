                    ...
                    <table border="0" cellpadding="0" cellspacing="0"  width='100%'>
                        <tr>
                            <td align="center" class="title" width="100%">
                                <script>
                                    document.write(getCompleteMenuPathHelp(SubMenuDUVRI,1));
                                </script>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <%  String HelpFrom = request.getParameter("HelpFrom");
                                        if (HelpFrom != null){
                                            if (HelpFrom.equals("VIEW")){
                                                ...
                                                <div align="justify">
                                                    <p>
                                                        <%=ApplicationConfigurator.LanguageManager.getString("Help.stampa.duvri.frase.1")%><br>
                                                        <%=ApplicationConfigurator.LanguageManager.getString("Cliccare.sull.icona") %> <img src="..\_images\new\NEW_ASSOCIATE.gif"> <%=ApplicationConfigurator.LanguageManager.getString("Help.stampa.duvri.frase.2")%><br>
                                                        <%=ApplicationConfigurator.LanguageManager.getString("Il.sistema.restituisce.il.messaggio")%><br>
                                                        <br>    
                                                        <%="<img src=\"..\\_images\\new\\Duvri-Generate-ok_" + ApplicationConfigurator.LanguageManager.getLocale().getLanguage() + ".jpg\">"%><br>
                                                        <br>
                                                        <%=ApplicationConfigurator.LanguageManager.getString("Help.stampa.duvri.frase.3")%><br>
                                                        <%=ApplicationConfigurator.LanguageManager.getString("Help.stampa.duvri.frase.4")%>
                                                    </p>
                                                </div>
                                            <%}
