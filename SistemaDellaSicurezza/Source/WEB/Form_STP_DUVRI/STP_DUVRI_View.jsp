...
<%--
            Document   : STP_DUVRI_View
            Created on : 15-mag-2008, 15.30.18
...
<script>
    ...
    function OnViewLoad() {
        parent.g_Handler.setCaptionHTML(getCompleteMenuPath(SubMenuDUVRI, 1));

        parent.g_Handler.New.URL = "/luna/WEB/Form_STP_DUVRI/STP_DUVRI_Form.jsp";

        parent.g_Handler.Open = parent.g_Handler.New;

        parent.g_Handler.Delete.URL = "/luna/WEB/Form_STP_DUVRI/STP_DUVRI_Delete.jsp";
        parent.g_Handler.Delete.OnBefore = OnBeforeDelete;
        parent.g_Handler.Help.URL = "/luna/WEB/Form_STP_DUVRI/STP_DUVRI_Help.jsp";
