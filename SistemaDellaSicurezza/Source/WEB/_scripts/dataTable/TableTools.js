...
TableTools.BUTTONS = {
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"fnComplete": function(nButton, oConfig, flash, text) {
			var
				...
				plural = (len==1) ? "a" : "e";
                                plural1 = (len==1) ? "e" : "i";
			this.fnInfo( '<h6>Tabella copiata</h6>'+
				'<p>Copiat'+plural+' ' +len+' voc'+plural1+' negli appunti.</p>',
				2000
			);
		}
	} ),
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Anteprima di stampa</h6><p>Si prega di utilizzare la funzione di stampa del browser (tasto destro del mouse) per "+
		  "stampare questa tabella. Premere il tasto 'esc' quando terminato.",
		"sMessage": null,
		"bShowAll": true,
