...
<file>
  <versions>	
    <version number="1.0" date="19/02/2004" author="Yuriy Kusharov">		
      <comments>
			   <comment date="19/02/2004" author="Yuriy Kusharov">
				 </comment>		
      </comments> 
    </version>
  </versions>
...
<%
	...
	try{
		if ("CATEGORIA".equals(strSubject)){
			bean.addCOD_CAG_DOC(id_attachment);
		}else
		if ("TIPOLOGIA".equals(strSubject)){
			bean.addCOD_TPL_DOC(id_attachment);
		}else
		if ("RUOLI".equals(strSubject)){
			bean.addCOD_RUO(id_attachment);
		}
		else{
			return;
		}
...
{
%><script>
	parent.tabbar.activeTab.Refresh(true);
</script><%
}%>
