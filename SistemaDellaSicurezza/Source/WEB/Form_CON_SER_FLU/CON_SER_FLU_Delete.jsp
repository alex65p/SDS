...
<%-- 
    Document   : CON_SER_FLU_Delete
    Created on : 19-mag-2008, 09.13.09
...
<%
    IContServFluidi ContServFluidi = null;
    ...
    if ( strCOD_FLU != null) {
        ...
        try {
            ...
            long lCOD_FLU = Long.parseLong(strCOD_FLU);
            home.remove(new ContServFluidiPK(lCOD_SRV, lCOD_FLU));
            boolean vuoto = home.getInfoOnDescFluidi(lCOD_SRV);
            if (vuoto) {
                con_ser_home.deleteDescFluidi(lCOD_SRV);
            }
        } catch (Exception ex) {
            ex.printStackTrace();
