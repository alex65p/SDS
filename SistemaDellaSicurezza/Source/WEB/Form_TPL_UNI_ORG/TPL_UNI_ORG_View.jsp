...
<div id="divContent">
    <%
        ...
        IUnitaOrganizzativa UnitaOrganizzativa;
    ...
    <table class="VIEW_TABLE" border="0">
        ...
        <tbody>
            <%
                ...
                String strNOM_TPL_UNI_ORG = c.checkStringEx("Nome", request.getParameter("NOME"), false);
                String strDES_TPL_UNI_ORG = c.checkStringEx("Descrizione", request.getParameter("DESC"), false);
                if (c.isError) {
                    String err = c.printErrors();
                    out.println("<script>alert(\"" + err + "\");</script>");
                    return;
                }
                Collection col = home.findEx(strNOM_TPL_UNI_ORG, strDES_TPL_UNI_ORG, 1);
                Iterator it = col.iterator();
                int iCount = 0;
                while (it.hasNext()) {
                    findEx_tpl_uni_org view = (findEx_tpl_uni_org) it.next();
            %>		<tr class="VIEW_TR" valign="top" INDEX="<%=view.COD_TPL_UNI_ORG%>" onclick="g_Handler.OnRowClick(this)" ondblclick="g_Handler.OnRowDblClick(this)">
                <%
                         
                        out.println("<td>&nbsp;" + ++iCount + "&nbsp;</td><td>&nbsp;"
                                + Formatter.format(view.NOM_TPL_UNI_ORG) + "&nbsp;</td><td>&nbsp;"
                                + Formatter.format(view.DES_TPL_UNI_ORG) + "&nbsp;</td></tr>");
...
<script>
    ...
    function OnViewLoad() {
        parent.g_Handler.setCaptionHTML(getCompleteMenuPath(SubMenuOrganizzazione, 0));
        parent.g_Handler.New.URL = "/luna/WEB/Form_TPL_UNI_ORG/TPL_UNI_ORG_Form.jsp";
        parent.g_Handler.New.Width = "700px";
        parent.g_Handler.New.Height = "240px";
        parent.g_Handler.Open = parent.g_Handler.New;
        parent.g_Handler.Delete.URL = "/luna/WEB/Form_TPL_UNI_ORG/TPL_UNI_ORG_Delete.jsp";
        parent.g_Handler.Delete.OnBefore = OnBeforeDelete;
        parent.g_Handler.Help.URL = "/luna/WEB/Form_TPL_UNI_ORG/TPL_UNI_ORG_Help.jsp";
