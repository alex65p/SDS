...
<%
    /*
     ...
     <description>Shablon formi TPL_MAC_Delete.jsp</description>
     </comment>		
     </comments> 
     </version>
     </versions>
...
<%
    if (request.getParameter("ID") != null) {
        String COD_TPL_MAC_DEL = request.getParameter("ID");
        ITipologieMacchineHome home = (ITipologieMacchineHome) PseudoContext.lookup("TipologieMacchineBean");
        Long lCOD_TPL_MAC = new Long(COD_TPL_MAC_DEL);
        try {
            home.remove(lCOD_TPL_MAC);
        } catch (Exception ex) {
