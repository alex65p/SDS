    ...
    <table border="0" class="VIEW_TABLE">
        ...
        <tbody>
            <%
                ...
                String strNOM_PRO_SAN = c.checkStringEx("Nome", request.getParameter("NOM_PRO_SAN"), false);
                String strDES_PRO_SAN = c.checkStringEx("Descrizione", request.getParameter("DES_PRO_SAN"), false);
                ...
                java.util.Collection col = home.findEx(lCOD_AZL, strNOM_PRO_SAN, strDES_PRO_SAN, 0);

                java.util.Iterator it = col.iterator();
                int nCount = 0;
                while (it.hasNext()) {
                    ProtocoleSanitare_Name_Address_View obj = (ProtocoleSanitare_Name_Address_View) it.next();
            %>		<tr class="VIEW_TR" valign="top" INDEX="<%=obj.COD_PRO_SAN%>" onclick="g_Handler.OnRowClick(this)" ondblclick="g_Handler.OnRowDblClick(this)">
                <%
                         
                        out.println("<td>&nbsp;" + ++nCount + "&nbsp;</td><td>&nbsp;"
                                + Formatter.format(obj.NOM_PRO_SAN) + "&nbsp;</td><td>&nbsp;"
                                + Formatter.format(obj.DES_PRO_SAN) + "&nbsp;</td></tr>");
...
<script>
    function OnBeforeDelete(id, tr) {
        return confirm(arraylng["MSG_0025"]);
    }

    function OnViewLoad() {
        parent.g_Handler.setCaptionHTML(getCompleteMenuPath(SubMenuVerificheSanitarie, 3));
        parent.g_Handler.New.URL = "/luna/WEB/Form_ANA_PRO_SAN/ANA_PRO_SAN_Form.jsp";
        parent.g_Handler.New.Width = 55;
        parent.g_Handler.New.Height = 31;
        parent.g_Handler.Open = parent.g_Handler.New;
        parent.g_Handler.Delete.URL = "/luna/WEB/Form_ANA_PRO_SAN/ANA_PRO_SAN_Delete.jsp";
        parent.g_Handler.Delete.OnBefore = OnBeforeDelete;
        parent.g_Handler.Help.URL = "/luna/WEB/Form_ANA_PRO_SAN/ANA_PRO_SAN_Help.jsp";
