 ...
 * @author Dario
 */
public class Report_REP_PSC extends Report {

    public long lCOD_PSC = 0;
    private boolean IncludeLogo = true;

    public Report_REP_PSC(long lCOD_PSC) {
        this.lCOD_PSC = lCOD_PSC;
    }

    public Report_REP_PSC(long lCOD_PSC, boolean _IncludeLogo) {
        this(lCOD_PSC);
    ...
    public void doReport() throws DocumentException, IOException, BadElementException, Exception { //----------------------------------------------------------------------
        ...
        IPSCHome home_psc = (IPSCHome) PseudoContext.lookup("PSCBean");
        IPSC bean_psc = home_psc.findByPrimaryKey(new Long(lCOD_PSC));
        ...
        writeTitle(ApplicationConfigurator.LanguageManager.getString("Schema.sinottico.storico.PSC"));
        if (IncludeLogo) {
            AddImage();
        }
...

        {
            ...
            int width[] = {15, 32, 12, 11, 10, 20};
            tbl.setWidths(width);
            java.util.Collection col = home_sg.getSezioneGeneralePSCByID_View(lCOD_PSC,bean_psc.getlCOD_PRO(),lCOD_AZL);
        ...
        }
        {
            ...
            java.util.Collection col = home_ss.getSchedediSicurezzaPSCByID_View(lCOD_PSC,bean_psc.getlCOD_PRO(),lCOD_AZL);
            java.util.Iterator it = col.iterator();
            while (it.hasNext()) {
        ...
        }
        {
            ...
            int width[] = {15, 32, 12, 11, 10, 20};
            tbl.setWidths(width);
            java.util.Collection col = home_fo.getFascicoloPSCByID_View(lCOD_PSC,bean_psc.getlCOD_PRO(),lCOD_AZL);
            java.util.Iterator it = col.iterator();
            while (it.hasNext()) {
        ...
        }
        {
            ...
            int width[] = {15, 32, 12, 11, 10, 20};
            tbl.setWidths(width);
            java.util.Iterator it = home_sp.getSezioneParticolarePSCByID_View(lCOD_PSC,bean_psc.getlCOD_PRO(),lCOD_AZL).iterator();
            while (it.hasNext()) {
