...
import com.apconsulting.luna.ejb.SchedaAttivitaSegnalazione.ISchedaAttivitaSegnalazioneHome;
import com.apconsulting.luna.ejb.SchedaAttivitaSegnalazione.Macchina_for_SCHMAC_View;
 ...
 * @author Dario
 */
public class Report_SCD_MAC extends Report {
    ...
    public void doReport() throws DocumentException, IOException, BadElementException, Exception {
        ...
        initDocument("the doc", null, ApplicationConfigurator.LanguageManager.getString(
