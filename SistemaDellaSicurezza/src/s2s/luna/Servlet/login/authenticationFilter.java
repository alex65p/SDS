...
public class authenticationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            if (wrappedRequest.getSession(false) == null
                    || wrappedRequest.getSession(false).getAttribute("PRINCIPAL") == null) {
                wrappedResponse.sendRedirect(ApplicationConfigurator.getApplicationURI() + "_security/logon.jsp");
            } else {
