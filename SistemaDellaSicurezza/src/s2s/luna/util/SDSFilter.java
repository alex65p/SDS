 ...
 * @author Dario
 */
public class SDSFilter implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (ApplicationConfigurator.FILTER_TRACE) {
            log("SDSFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (ApplicationConfigurator.FILTER_TRACE) {
            log("SDSFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (ApplicationConfigurator.FILTER_TRACE) {
            log("SDSFilter:doFilter()");
        }

        // Imposta la decodifica secondo la quale i caratteri viaggiano nelle richieste del browser.
        if (ApplicationConfigurator.REQUEST_CHARACTER_ENCODING != null){
            request.setCharacterEncoding(ApplicationConfigurator.REQUEST_CHARACTER_ENCODING);            
        }

        if (ApplicationConfigurator.FILTER_TRACE) {
            log("SDSFilter:Set request character encoding: " + request.getCharacterEncoding());
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (ApplicationConfigurator.FILTER_TRACE) {
                log("SDSFilter: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("SDSFilter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (ApplicationConfigurator.FILTER_TRACE) {
                log("SDSFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (ApplicationConfigurator.FILTER_TRACE) {
                log("SDSFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (ApplicationConfigurator.FILTER_TRACE) {
                log("SDSFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (ApplicationConfigurator.FILTER_TRACE) {
                log("SDSFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (ApplicationConfigurator.FILTER_TRACE) {
                log("SDSFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
