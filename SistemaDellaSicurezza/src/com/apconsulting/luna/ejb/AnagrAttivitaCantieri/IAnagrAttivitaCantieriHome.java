 ...
 * @author Alessandro
 */
public interface IAnagrAttivitaCantieriHome extends EJBHome{

 public IAnagrAttivitaCantieri create(
        String strDES_ATT,String strCOD, String strNOM_ATT, long lCOD_AZL ) throws CreateException;
