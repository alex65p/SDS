...
public interface IRischioCantiereHome extends EJBHome, EJBLocalHome {

    public IRischioCantiere create(long lCOD_AZL, String strNOM_RSO, String strDES_RSO, java.sql.Date dtDAT_RIL, String strNOM_RIL_RSO, String strCLF_RSO, long lPRB_EVE_LES, long lENT_DAN, long lFRQ_RIP_ATT_DAN, long lNUM_INC_INF, float lSTM_NUM_RSO, long lRFC_VLU_RSO_MES, long lCOD_FAT_RSO, long lCOD_RSO_RPO, java.util.ArrayList alAziende) throws CreateException;

    public void remove(Object primaryKey, java.util.ArrayList alAziende);

    public IRischioCantiere findByPrimaryKey(RischioPK primaryKey) throws FinderException;
    // -- A.Kolesnik
