...
public class AziendaTelefonoBean extends BMPEntityBean implements IAziendaTelefonoHome, IAziendaTelefono {
    ...
    //</comment>
////////////////////// CONSTRUCTOR///////////////////
    private static AziendaTelefonoBean ys = null;

    private AziendaTelefonoBean() {
    }

    public static AziendaTelefonoBean getInstance() {
        if (ys == null) {
            ys = new AziendaTelefonoBean();
        }
        return ys;
    }
...
//<comment description="setter/getters">
    ...
    public void setTPL_NUM_TEL__NUM_TEL__COD_AZL(String newTPL_NUM_TEL, String newNUM_TEL, long newCOD_AZL) {
        if ((TPL_NUM_TEL.equals(newTPL_NUM_TEL)) & (NUM_TEL.equals(newNUM_TEL)) & (COD_AZL == newCOD_AZL)) {
            return;
        }
