...
public class NazionalitaBean extends BMPEntityBean implements INazionalitaHome, INazionalita {
    ...
    //</comment>
////////////////////////// CONSTRUCTOR//////////////////////////////////////////
    private static NazionalitaBean ys = null;

    private NazionalitaBean() {
        //
    }

    public static NazionalitaBean getInstance() {
        if (ys == null) {
            ys = new NazionalitaBean();
        }
        return ys;
    }
...
//----------------------------------------------------------
    ...
    public void ejbStore() {
        ...
        try {
            ...
            if (ps.executeUpdate() == 0) {
                throw new NoSuchEntityException("Nazionalita with ID= not found");
            }
        } catch (Exception ex) {
            throw new EJBException(ex);
        } finally {
...
//<comment description="setter/getters">  
    ...
    public void setNOM_STA_COD_LNG(String newNOM_STA, long newCOD_LNG) {
        if ((NOM_STA.equals(newNOM_STA)) & (COD_LNG == newCOD_LNG)) {
            return;
        }
        NOM_STA = newNOM_STA;
        COD_LNG = newCOD_LNG;
