...
public interface IFattoriRischioCantiereHome extends EJBHome{


    public IFattoriRischioCantiere create(String strNOM_FAT_RSO, long lNUM_FAT_RSO, long lCOD_CAG_FAT_RSO) throws CreateException;

    public IFattoriRischioCantiere findByPrimaryKey(Long primaryKey) throws FinderException;
