 ...
 */
package com.apconsulting.luna.ejb.Collegamenti;
...
public class CollegamentiBean extends BMPEntityBean implements ICollegamenti, ICollegamentiHome {
    ...
    private static CollegamentiBean ys = null;

    private CollegamentiBean() {
        //
    }

    public static CollegamentiBean getInstance() {
        if (ys == null) {
            ys = new CollegamentiBean();
        }
        return ys;
    }
    ...
    public void setIDZ_COL_INT(String strIDZ_COL_INT) {
        if ((this.strIDZ_COL_INT != null) && (this.strIDZ_COL_INT.equals(strIDZ_COL_INT))) {
            return;
        }
        this.strIDZ_COL_INT = strIDZ_COL_INT;
        setModified();
    ...
    public void setDES_COL_INT(String strDES_COL_INT) {
        if ((this.strDES_COL_INT != null) && (this.strDES_COL_INT.equals(strDES_COL_INT))) {
            return;
        }
