 ...
 */
package com.apconsulting.luna.ejb.TipologieMacchine;
...
public class TipologieMacchineBean extends BMPEntityBean implements ITipologieMacchine, ITipologieMacchineHome {
    ...
    private static TipologieMacchineBean ys = null;

    private TipologieMacchineBean() {
    }

    public static TipologieMacchineBean getInstance() {
        if (ys == null) {
            ys = new TipologieMacchineBean();
        }
        return ys;
    }
...
//<comment description="setter/getters">
    ...
    public void setDES_TPL_MAC(String newDES_TPL_MAC) {
        if (DES_TPL_MAC.equals(newDES_TPL_MAC)) {
            return;
        }
