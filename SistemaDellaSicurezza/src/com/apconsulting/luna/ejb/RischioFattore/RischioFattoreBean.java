...
public class RischioFattoreBean extends BMPEntityBean implements IRischioFattore, IRischioFattoreHome {
    ...
    private static RischioFattoreBean ys = null;

    private RischioFattoreBean() {
    }

    public static RischioFattoreBean getInstance() {
        if (ys == null) {
            ys = new RischioFattoreBean();
        }
        return ys;
    }
    ...
    public Collection getFattoriWithRischi4Categoria(long lCOD_CAG_FAT_RSO, long lCOD_AZL) {
        return (new RischioFattoreBean()).ejbGetFattoriWithRischi4Categoria(lCOD_CAG_FAT_RSO, lCOD_AZL);
    }
    ...
    public Collection ejbGetReport_RischioFattore_RischioView(long lCOD_AZL, long lCOD_MAN, long lCOD_OPE_SVO, long lCOD_FAT_RSO) {
        BMPConnection bmp = getConnection();
        try {
            PreparedStatement ps = bmp.prepareStatement(SQLContainer.getReport_RischioFattore_RischioView_OPE_SVO_QUERY());
            ps.setLong(1, lCOD_FAT_RSO);
    ...
    public Collection ejbGetReport_RischioFattore_RischioView(long lCOD_AZL, long lCOD_MAN, long lCOD_FAT_RSO) {
        BMPConnection bmp = getConnection();
        try {
            PreparedStatement ps = bmp.prepareStatement(SQLContainer.getReport_RischioFattore_RischioView_CAG_FAT_RSO_QUERY());
    ...
    public Collection ejbGetReport_RischioFattore_RischioView_UO(long lCOD_AZL, long lCOD_UNI_ORG, long lCOD_FAT_RSO) {
        BMPConnection bmp = getConnection();
        try {
            PreparedStatement ps = bmp.prepareStatement(
                    SQLContainer.getReport_RischioFattore_RischioView_UO_QUERY());
    ...
    public Collection ejbGetReport_RischioFattore_ComboView(long lCOD_AZL, long lCOD_MAN, long lCOD_OPE_SVO) {
        BMPConnection bmp = getConnection();
        try {
            PreparedStatement ps = bmp.prepareStatement(SQLContainer.getEjbGetReport_RischioFattore_ComboView());
            ps.setLong(1, lCOD_OPE_SVO);
            ps.setLong(2, lCOD_MAN);
            ps.setLong(3, lCOD_AZL);
            ps.setLong(4, lCOD_OPE_SVO);
    ...
    public Collection ejbGetReport_RischioFattore_ComboView_CAG_FAT_RSO(long lCOD_AZL, long lCOD_MAN, long lCOD_CAG_FAT_RSO) {
        BMPConnection bmp = getConnection();
        try {
            PreparedStatement ps = bmp.prepareStatement(SQLContainer.getEjbGetReport_RischioFattore_ComboView_CAG_FAT_RSO());
            ps.setLong(1, lCOD_CAG_FAT_RSO);
            ps.setLong(2, lCOD_MAN);
            ps.setLong(3, lCOD_AZL);
...
// %%%Link%%% Table DOC_FAT_RSO_TAB
    ...
    public Collection ejbFindEx(String strNOM_FAT_RSO, String strDES_FAT_RSO, long lNUM_FAT_RSO, long lCOD_CAG_FAT_RSO, long lCOD_NOR_SEN, int iOrderParameter) {
        ...
        try {
            ...
            if (lNUM_FAT_RSO != 0) {
                ps.setLong(i++, lNUM_FAT_RSO);
            }
            if (lCOD_CAG_FAT_RSO != 0) {
                ps.setLong(i++, lCOD_CAG_FAT_RSO);
            }
            if (lCOD_NOR_SEN != 0) {
                ps.setLong(i, lCOD_NOR_SEN);
            }
            ResultSet rs = ps.executeQuery();
            java.util.ArrayList ar = new java.util.ArrayList();
            while (rs.next()) {
