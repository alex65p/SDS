...
public class InfortuniIncidentiCantiereBean extends BMPEntityBean implements IInfortuniIncidentiCantiere, IInfortuniIncidentiCantiereHome {
...
////////////////////// CONSTRUCTOR///////////////////
    private static InfortuniIncidentiCantiereBean ys = null;

    private InfortuniIncidentiCantiereBean() {
        //
    }

    public static InfortuniIncidentiCantiereBean getInstance() {
        if (ys == null) {
            ys = new InfortuniIncidentiCantiereBean();
        }
        return ys;
    }
    ...
    public void remove(Object primaryKey) {
        InfortuniIncidentiCantiereBean bean = new InfortuniIncidentiCantiereBean();
        try {
    ...
    public IInfortuniIncidentiCantiere create(long lCOD_AGE_MAT, long lCOD_TPL_FRM_INO, long lCOD_NAT_LES, long lCOD_SED_LES, long lCOD_CAN, long lCOD_LUO_FSC, long lCOD_DPD,long lCOD_DTE, long lCOD_AZL) throws javax.ejb.CreateException {
        InfortuniIncidentiCantiereBean bean = new InfortuniIncidentiCantiereBean();
        try {
            Object primaryKey = bean.ejbCreate(lCOD_AGE_MAT, lCOD_TPL_FRM_INO, lCOD_NAT_LES, lCOD_SED_LES, lCOD_CAN, lCOD_LUO_FSC, lCOD_DPD,lCOD_DTE, lCOD_AZL);
            bean.setEntityContext(new EntityContextWrapper(primaryKey));
            bean.ejbPostCreate(lCOD_AGE_MAT, lCOD_TPL_FRM_INO, lCOD_NAT_LES, lCOD_SED_LES, lCOD_CAN, lCOD_LUO_FSC, lCOD_DPD, lCOD_DTE, lCOD_AZL);
            return bean;
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public IInfortuniIncidentiCantiere findByPrimaryKey(Long primaryKey) throws javax.ejb.FinderException {
        InfortuniIncidentiCantiereBean bean = new InfortuniIncidentiCantiereBean();
        try {
            bean.setEntityContext(new EntityContextWrapper(primaryKey));
            bean.ejbActivate();
    ...
    public Collection getInfortuniIncidenti_View(long lCOD_AZL) {
        return (new InfortuniIncidentiCantiereBean()).ejbGetInfortuniIncidenti_View(lCOD_AZL);
    }

    public Collection findEx(long lCOD_AZL, long COD_LUO_FSC, long COD_DPD, long COD_DTE, long COD_NAT_LES, long COD_AGE_MAT, long COD_TPL_FRM_INO, long COD_SED_LES, long COD_CAN) {
        return (new InfortuniIncidentiCantiereBean()).ejbfindEx(lCOD_AZL, COD_LUO_FSC, COD_DPD, COD_DTE, COD_NAT_LES, COD_AGE_MAT, COD_TPL_FRM_INO, COD_SED_LES, COD_CAN);
    }

//<report>
    public SchedaInfortuniIncidenteCantiereView getSchedaInfortunioIncidenteView(long lCOD_AZL, long lCOD_INO) {
        return (new InfortuniIncidentiCantiereBean()).ejbGetISchedaInfortunioIncidenteView(lCOD_AZL, lCOD_INO);
    }

    public Collection getElencoInfortuniIncidentiView(long lCOD_AZL, String strDAT_DAL, String strDAT_AL) {
        return (new InfortuniIncidentiCantiereBean()).ejbGetElencoInfortuniIncidentiView(lCOD_AZL, strDAT_DAL, strDAT_AL);
    }

    public Collection getDocumenti_View(long lCOD_INO, long COD_AZL) {
        return (new InfortuniIncidentiCantiereBean()).getEjbGetDocumenti_View(lCOD_INO, COD_AZL);
    }

    public Long ejbCreate(long lCOD_AGE_MAT, long lCOD_TPL_FRM_INO, long lCOD_NAT_LES, long lCOD_SED_LES, long lCOD_CAN, long lCOD_LUO_FSC, long lCOD_DPD, long lCOD_DTE, long lCOD_AZL) {
        ...
        try {
            ...
            PreparedStatement ps = bmp.prepareStatement(
                    "INSERT INTO ana_ino_can_tab "
                        + "(cod_ino,cod_age_mat,cod_tpl_frm_ino, "
                        + "cod_nat_les,cod_sed_les,cod_can,cod_luo_fsc, "
                        + "cod_dpd,cod_dte,cod_azl) "
                    + "VALUES"
                        + "(?,?,?,?,?,?,?,?,?,?)");
            ps.setLong(1, lCOD_INO);
            ps.setLong(2, lCOD_AGE_MAT);
            if (lCOD_TPL_FRM_INO == 0) {
            ...
            ps.setLong(6, lCOD_CAN);
            ps.setLong(7, lCOD_LUO_FSC);
            ps.setLong(8, lCOD_DPD);
            ps.setLong(9, lCOD_DTE);
    ...
    public void ejbPostCreate(long lCOD_AGE_MAT, long lCOD_TPL_FRM_INO, long lCOD_NAT_LES, long lCOD_SED_LES, long lCOD_CAN, long lCOD_LUO_FSC, long lCOD_DPD, long lCOD_DTE, long lCOD_AZL) {
    }

    public Collection ejbFindAll() {
        BMPConnection bmp = getConnection();
        try {
            PreparedStatement ps = bmp.prepareStatement("SELECT cod_ino FROM ana_ino_can_tab");
    ...
    public void ejbLoad() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                lPRG_INI = rs.getLong(15);
                IN_ITI = rs.getString(16);
                NON_IND = rs.getString(17);
                INT_TRA_DIT = rs.getString(18);
                MEZ_TRA = rs.getString(19);
                dtDAT_TRA = rs.getDate(20);
                LUO_TRA = rs.getString(21);
                DIN_INC_INO = rs.getString(22);
                strDES_EVE_INO = rs.getString(23);
                strDES_ANL_INO = rs.getString(24);
                strDES_CRZ_INO = rs.getString(25);
                strDES_RAC_INO = rs.getString(26);
                strDES_DVU_INO = rs.getString(27);
                lCOD_AGE_MAT = rs.getLong(28);
                lCOD_TPL_FRM_INO = rs.getLong(29);
                lCOD_NAT_LES = rs.getLong(30);
                lCOD_SED_LES = rs.getLong(31);
                lCOD_CAN = rs.getLong(32);
                lCOD_LUO_FSC = rs.getLong(33);
                lCOD_DPD = rs.getLong(34);
                lCOD_DTE = rs.getLong(35);
                lCOD_AZL = rs.getLong(36);
                lCOD_INO_REL = rs.getLong(37);
            } else {
    ...
    public void ejbRemove() {
        BMPConnection bmp = getConnection();
        try {
            PreparedStatement ps = bmp.prepareStatement("DELETE FROM ana_ino_can_tab WHERE cod_ino=?");
            ps.setLong(1, lCOD_INO);
    ...
    public void ejbStore() {
        ...
        BMPConnection bmp = getConnection();
        try {
            PreparedStatement ps = bmp.prepareStatement("UPDATE ana_ino_can_tab SET "
                    + "nom_com_ino=?, "
                    + "dat_com_ino=?, "
                    + "dat_eve_ino=?, "
                    + "ora_eve_ino=?, "
            ...
            if (lPRG_INI == 0) {
                ...
                ps.setLong(14, lPRG_INI);
            }
            ps.setString(15, IN_ITI);
            if (IN_ITI != null && IN_ITI.equals("S")) {
                ps.setString(15, IN_ITI);
            } else {
                ps.setString(15, "N");
            }
            ps.setString(16, NON_IND);
            if (NON_IND != null && NON_IND.equals("S")) {
                ps.setString(16, NON_IND);
            } else {
                ps.setString(16, "N");
            }
            ps.setString(17, INT_TRA_DIT);
            if (INT_TRA_DIT != null && INT_TRA_DIT.equals("S")) {
                ps.setString(17, INT_TRA_DIT);
            } else {
                ps.setString(17, "N");
            }
            ps.setString(18, MEZ_TRA);
            ps.setDate(19, dtDAT_TRA);
            ps.setString(20, LUO_TRA);
            ps.setString(21, DIN_INC_INO);
            ps.setString(22, strDES_EVE_INO);
            ps.setString(23, strDES_ANL_INO);
            ps.setString(24, strDES_CRZ_INO);
            ps.setString(25, strDES_RAC_INO);
            ps.setString(26, strDES_DVU_INO);
            ps.setLong(27, lCOD_AGE_MAT);
            if (lCOD_TPL_FRM_INO == 0) {
                ps.setNull(28, java.sql.Types.BIGINT);
            } else {
                ps.setLong(28, lCOD_TPL_FRM_INO);
            }
            ps.setLong(29, lCOD_NAT_LES);
            if (lCOD_SED_LES == 0) {
                ps.setNull(30, java.sql.Types.BIGINT);
            } else {
                ps.setLong(30, lCOD_SED_LES);
            }
            ps.setLong(31, lCOD_CAN);
            ps.setLong(32, lCOD_LUO_FSC);
            ps.setLong(33, lCOD_DPD);
            ps.setLong(34, lCOD_DTE);
            ps.setLong(35, lCOD_AZL);
            // ps.setLong(36, lCOD_INO_REL);
            if (lCOD_INO_REL != 0) {
                ps.setLong(36, lCOD_INO_REL);
            } else {
                ps.setNull(36, java.sql.Types.NUMERIC);
            }
            ps.setLong(37, lCOD_INO);
    ...
    public void setPRG_INI(long lPRG_INI) {
        if (this.lPRG_INI == lPRG_INI) {
            return;
        }
        this.lPRG_INI = lPRG_INI;
        setModified();
    }
    ...
    public void setINT_TRA_DIT(String INT_TRA_DIT) {
        if ((this.INT_TRA_DIT != null) && (this.INT_TRA_DIT.equals(INT_TRA_DIT))) {
            return;
        }
        this.INT_TRA_DIT = INT_TRA_DIT;
        setModified();
    }
    ...
    public Collection ejbGetInfortuniIncidenti_View(long lCOD_AZL) {
        BMPConnection bmp = getConnection();
        try {
            PreparedStatement ps = bmp.prepareStatement("SELECT b.cod_ino, b.nom_com_ino, b.dat_com_ino, b.dat_eve_ino, c.cog_dpd, c.nom_dpd FROM ana_ino_can_tab b, view_ana_dpd_tab c WHERE b.cod_azl = ? AND b.cod_dpd = c.cod_dpd ORDER BY dat_com_ino,dat_eve_ino ");
            ps.setLong(1, lCOD_AZL);

            ResultSet rs = ps.executeQuery();
            java.util.ArrayList al = new java.util.ArrayList();
            while (rs.next()) {
                InfortuniIncidentiCantiere_View obj = new InfortuniIncidentiCantiere_View();
    ...
    public SchedaInfortuniIncidenteCantiereView ejbGetISchedaInfortunioIncidenteView(long lCOD_AZL, long lCOD_INO) {
        BMPConnection bmp = getConnection();
        try {
            ...
            ps.setLong(1, lCOD_INO);
            ResultSet rs = ps.executeQuery();
            SchedaInfortuniIncidenteCantiereView obj = new SchedaInfortuniIncidenteCantiereView();
            if (rs.next()) {
                /*
    ...
    public Collection ejbfindEx(
        ...
        try {
            ...
            while (rs.next()) {
                ...
                obj.IN_ITI = rs.getString(8);
                obj.NON_IND = rs.getString(9);
                obj.INT_TRA_DIT = rs.getString(10);
                al.add(obj);
            }
            bmp.close();
            return al;
    ...
    public Collection getEjbGetDocumenti_View(long lCOD_INO, long COD_AZL) {
        ...
        try {
            ...
            java.util.ArrayList al = new java.util.ArrayList();
            while (rs.next()) {
                InfortuniIncidentiCantiere_Documenti_View obj = new InfortuniIncidentiCantiere_Documenti_View();
    ...
    public Collection getInfortuniIncidentiDipendenteView(long COD_DPD, long COD_AZL, String DAT_EVE_INO, long COD_INO, long COD_INO_REL) {
        return (new InfortuniIncidentiCantiereBean()).ejbGetElencoInfortuniIncidentiDipendenteCantiereView(COD_DPD, COD_AZL, DAT_EVE_INO, COD_INO, COD_INO_REL);
    }

     public Collection ejbGetElencoInfortuniIncidentiDipendenteCantiereView(long COD_DPD, long COD_AZL, String DAT_EVE_INO, long COD_INO, long COD_INO_REL) {
        BMPConnection bmp = getConnection();
        String sSQL1 = SQLContainer.getEjbGetRiapertura_Infortuni_Cantiere_View(DAT_EVE_INO);
        try {
            ...
            while (rs.next()) {
                ...
                obj.strNOM_TPL_FRM_INO = rs.getString(5);
                obj.lCOD_INO = rs.getLong(6);
                obj.strNOM_SED_LES = rs.getString(7);
                al.add(obj);
            }
            bmp.close();
            return al;
