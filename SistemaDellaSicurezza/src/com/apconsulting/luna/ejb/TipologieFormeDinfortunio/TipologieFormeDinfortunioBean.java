...
package com.apconsulting.luna.ejb.TipologieFormeDinfortunio;
...
private static TipologieFormeDinfortunioBean ys = null;

    private TipologieFormeDinfortunioBean() {
        //
    }

    public static TipologieFormeDinfortunioBean getInstance() {
        if (ys == null) {
            ys = new TipologieFormeDinfortunioBean();
        }
        return ys;
    }
