 ...
 * @author Dario
 */
public interface IGestioneTabellareHome extends EJBHome {

    public IGestioneTabellare create(long lNUM_CLN, long lCOD_PRG) throws CreateException;

    public IGestioneTabellare findByPrimaryKey(Long primaryKey) throws FinderException;
