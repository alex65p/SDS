 ...
 * @author Dario
 */
public class TipologiaDPIBean extends BMPEntityBean implements ITipologiaDPI, ITipologiaDPIHome //class TipologiaDPIBean extends ITipologiaDPIHome
{
    ...
    //</comment>
////////////////////// CONSTRUCTOR///////////////////
    private static TipologiaDPIBean ys = null;

    private TipologiaDPIBean() {
    }

    public static TipologiaDPIBean getInstance() {
        if (ys == null) {
            ys = new TipologiaDPIBean();
        }
        return ys;
    }
    ...
    public void ejbRemove() {
        ...
        try {
            ...
            if (ps.executeUpdate() == 0) {
                throw new NoSuchEntityException("Tipologia DPI con ID=" + COD_TPL_DPI + " non è trovata");
            }
        } catch (Exception ex) {
            throw new EJBException(ex);
        } finally {
...
//----------------------------------------------------------
    ...
    public void ejbStore() {
        ...
        try {
            ...
            if (ps.executeUpdate() == 0) {
                throw new NoSuchEntityException("Tipologia DPI with ID= non &egrave trovata");
            }
        } catch (Exception ex) {
            throw new EJBException(ex);
        } finally {
...
//<comment description="setter/getters">
    ...
    public void setNOM_TPL_DPI(String newNOM_TPL_DPI) {
        if (NOM_TPL_DPI.equals(newNOM_TPL_DPI)) {
            return;
        }
    ...
    public void setDES_CAR_DPI(String newDES_CAR_DPI) {
        if (DES_CAR_DPI.equals(newDES_CAR_DPI)) {
            return;
        }
    ...
    public void setMDL_PTR_UTI_DPI(String newMDL_PTR_UTI_DPI) {
        if (MDL_PTR_UTI_DPI != null) {
            if (MDL_PTR_UTI_DPI.equals(newMDL_PTR_UTI_DPI)) {
                return;
            }
        }
    ...
    public void setIMG_CSI_DPI(String newIMG_CSI_DPI) {
        if (IMG_CSI_DPI != null) {
            if (IMG_CSI_DPI.equals(newIMG_CSI_DPI)) {
                return;
            }
        }
...
//-----------------------------#############################################
    ...
    public void removeCOD_NOR_SEN(long newCOD_NOR_SEN) {
        ...
        try {
            ...
            if (ps.executeUpdate() == 0) {
                throw new NoSuchEntityException("Normative con ID=" + newCOD_NOR_SEN + " non &egrave trovata");
            }
        } catch (Exception ex) {
            throw new EJBException(ex);
        } finally {
    ...
    public void removeCOD_DOC(long newCOD_DOC) {
        ...
        try {
            ...
            if (ps.executeUpdate() == 0) {
                throw new NoSuchEntityException("Documento con ID=" + newCOD_DOC + " non &egrave trovato");
            }
        } catch (Exception ex) {
            throw new EJBException(ex);
        } finally {
...
//--- view dla ANA_DOC_TAB cherez DOC_DPI_TAB
    ...
    public Collection ejbFindEx(
        ...
        try {
            ...
            if (strNOM_TPL_DPI != null) {
                ps.setString(i++, strNOM_TPL_DPI.toUpperCase());
            }
            if (strDES_CAR_DPI != null) {
                ps.setString(i++, strDES_CAR_DPI.toUpperCase());
            }
            ResultSet rs = ps.executeQuery();
