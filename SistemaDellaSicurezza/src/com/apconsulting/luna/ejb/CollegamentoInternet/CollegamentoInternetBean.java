...
////////////////////// CONSTRUCTOR///////////////////
    private static CollegamentoInternetBean ys = null;

    private CollegamentoInternetBean() {
        //
    }

    public static CollegamentoInternetBean getInstance() {
        if (ys == null) {
            ys = new CollegamentoInternetBean();
        }
        return ys;
    }
