 ...
 * @author Alessandro
 */
public interface ISchedediSicurezzaHome extends EJBHome {
    
public ISchedediSicurezza create(String strOGG, String strCOD, String strREV,java.sql.Date dtDAT_EMI,java.sql.Date dtDAT_PRO, String DOC_COL,long lCOD_PSC,long lCOD_PRO, long lCOD_AZL) throws CreateException;

    public void remove(Object primaryKey);

    public ISchedediSicurezza findByPrimaryKey(Long primaryKey) throws FinderException;
