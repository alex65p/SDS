 ...
 */
package com.apconsulting.luna.ejb.Articoli;
 ...
 * @author Dario
 */
public class ArticoliBean extends BMPEntityBean implements IArticoliHome, IArticoli {
    Long COD_ARL = null;
    String IDEN;
    String NOM_ARL;
    String DES_ARL;
    ////////////////////// CONSTRUCTOR///////////////////
    private static ArticoliBean ys = null;

    private ArticoliBean() {
    }

    public static ArticoliBean getInstance() {
        if (ys == null) {
            ys = new ArticoliBean();
        }
        return ys;
...
// (Home Intrface) create()
    public IArticoli create(String sIDEN,String sNOM_ARL, String sDES_ARL) throws CreateException {
        ArticoliBean bean = new ArticoliBean();
        try {
...
// (Home Intrface) remove()
    ...
    public void remove(Object primaryKey) {
        ArticoliBean iRapportoBean = new ArticoliBean();
        try {
    ...
    public IArticoli findByPrimaryKey(Long primaryKey) throws FinderException {
        ArticoliBean iRapportoBean = new ArticoliBean();
        try {
...
///////////////////////////////////////////////////
    ...
    public Collection findEx(Long lCOD_ARL, String sIDEN, String sNOM_ARL, String sDES_ARL) {
        return (new ArticoliBean()).ejbfindEx(lCOD_ARL,sIDEN,sNOM_ARL,sDES_ARL);
    }
