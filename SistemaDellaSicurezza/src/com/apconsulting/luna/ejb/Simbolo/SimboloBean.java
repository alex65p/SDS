 ...
 */
package com.apconsulting.luna.ejb.Simbolo;
...
public class SimboloBean extends BMPEntityBean implements ISimbolo, ISimboloHome {
    ...
    private static SimboloBean ys = null;

    private SimboloBean() {
    }

    public static SimboloBean getInstance() {
        if (ys == null) {
            ys = new SimboloBean();
        }
        return ys;
    ...
    public void setDES_SIM(String strDES_SIM) {
        if ((this.strDES_SIM != null) && (this.strDES_SIM.equals(strDES_SIM))) {
            return;
        }
        this.strDES_SIM = strDES_SIM;
        setModified();
