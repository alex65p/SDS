...
public class PercorsiFormativiBean extends BMPEntityBean implements IPercorsiFormativi, IPercorsiFormativiHome {
  ...
  //</member-varibles>
    ...
    private static PercorsiFormativiBean ys = null;

    private PercorsiFormativiBean() {
        //System.err.println("AgenteMaterialeBean constructor<br>");
    }

    public static PercorsiFormativiBean getInstance() {
        if (ys == null) {
            ys = new PercorsiFormativiBean();
        }
        return ys;
    }
    ...
    public Collection ejbFindEx(
        ...
        try {
            ...
            if (strNOM_PCS_FRM != null) {
                ps.setString(i++, strNOM_PCS_FRM.toUpperCase());
            }
    ...
    public void setNOM_PCS_FRM(String strNOM_PCS_FRM) {
        if ((this.strNOM_PCS_FRM != null) && (this.strNOM_PCS_FRM.equals(strNOM_PCS_FRM))) {
            return;
        }
        this.strNOM_PCS_FRM = strNOM_PCS_FRM;
        setModified();
    ...
    public void setDES_PCS_FRM(String strDES_PCS_FRM) {
        if ((this.strDES_PCS_FRM != null) && (this.strDES_PCS_FRM.equals(strDES_PCS_FRM))) {
            return;
        }
  ...
  //</setter-getters>
    ...
    public void removeCOD_COR(long newCOD_COR) {
        ...
        try {
            ...
            if (ps.executeUpdate() == 0) {
                throw new NoSuchEntityException("Corsi con ID=" + newCOD_COR + " non &egrave trovata");
            }
        } catch (Exception ex) {
            throw new EJBException(ex);
        } finally {
